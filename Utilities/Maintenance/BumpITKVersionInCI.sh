...
# - Deprecate Python 3.6 and add Python 3.10 3.11 3.12 3.13 wheels
...
find . -type f | \
	...
	-e 's#python-version: \[.*#python-version: [39, 310, 311, 312, 313]#g' \
	-e 's#python-version-minor: \[.*#python-version-minor: [9, 10, 11, 12, 13]#g' \
