  ...
  DICOMParser*, doublebyte, doublebyte, DICOMParser::VRTypes, unsigned char* data, quadbyte len)
{
  ...
  {
    dicom_stream::cerr
      << "DICOMAppHelper:: Found contour data tag (0x3006, 0x0050) without a matching contour "
         "sequence tag (0x3006, 0x0040)."
      << dicom_stream::endl;
  }
  ...
  {
    dicom_stream::cerr
      << "DICOMAppHelper:: Found contour data tag (0x3006, 0x0050) without a matching number of "
         "contour points tag (0x3006, 0x0046)."
      << dicom_stream::endl;
  }
  else
  {
  ...
  DICOMParser*, doublebyte, doublebyte, DICOMParser::VRTypes, unsigned char* data, quadbyte)
{
  ...
  else if (this->Implementation->SeriesUIDToContoursMap[this->CurrentSeriesUID].back().size() != 0)
  {
    dicom_stream::cerr
      << "DICOMAppHelper:: Found number of contour points tag (0x3006, 0x0046) without a matching "
         "contour geometric type tag (0x3006, 0x0042)."
      << dicom_stream::endl;
  }
  else
  {
