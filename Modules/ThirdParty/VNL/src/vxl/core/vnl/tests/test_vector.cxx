...
vnl_vector_test_int()
{
...

  {
    ...
    v.flip();
    TEST("v.flip()", (3 == v[0] && 2 == v[1] && 1 == v[2] && 0 == v[3]), true);
    v.flip(0, v.size());
    TEST("v.flip(0,v.size())", (0 == v[0] && 1 == v[1] && 2 == v[2] && 3 == v[3]), true);
    v.flip(0, 3);
    TEST("v.flip(0,3)", (2 == v[0] && 1 == v[1] && 0 == v[2] && 3 == v[3]), true);
    v.flip(1, 4);
    TEST("v.flip(1,4)", (2 == v[0] && 3 == v[1] && 0 == v[2] && 1 == v[3]), true);
  }
...

  {
    ...
    v_temp = v;
    TEST("v[0]", (0 == v_temp[0] && 1 == v_temp[1] && 2 == v_temp[2] && 3 == v_temp[3]), true);
    v_temp = v.roll(0);
    TEST("v.roll(0)", (0 == v_temp[0] && 1 == v_temp[1] && 2 == v_temp[2] && 3 == v_temp[3]), true);
    v_temp = v.roll(v.size());
    TEST("v.roll(v.size())", (0 == v_temp[0] && 1 == v_temp[1] && 2 == v_temp[2] && 3 == v_temp[3]), true);
    ...
    TEST("v.roll(1)", (3 == v_temp[0] && 0 == v_temp[1] && 1 == v_temp[2] && 2 == v_temp[3]), true);
    v_temp = v.roll(5); // Positive, in range
    TEST("v.roll(5)", (3 == v_temp[0] && 0 == v_temp[1] && 1 == v_temp[2] && 2 == v_temp[3]), true);
    v_temp = v.roll(-1); // Positive, in range
    TEST("v.roll(-1)", (1 == v_temp[0] && 2 == v_temp[1] && 3 == v_temp[2] && 0 == v_temp[3]), true);
    v_temp = v.roll(-5); // Positive, in range
    TEST("v.roll(-5)", (1 == v_temp[0] && 2 == v_temp[1] && 3 == v_temp[2] && 0 == v_temp[3]), true);
  }
