                       ...
                       int compressionLevel)
{
    ...
    /*int ret =*/
    deflateInit(&z, compressionLevel);
    // assert(ret == Z_OK);
    ...
    do
    {
        ...
        do
        {
            ...
            memcpy(reinterpret_cast<char*>(compressed_data) + cur_out_start, reinterpret_cast<char*>(output_buffer),
                   static_cast<size_t>(count_out));
