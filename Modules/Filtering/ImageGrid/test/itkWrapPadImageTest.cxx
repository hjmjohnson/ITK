...
itkWrapPadImageTest(int, char *[])
{
  ...
  else
  {
    ...
    {
      int const             row = itIn1.GetIndex()[0];
      int const             column = itIn1.GetIndex()[1];
  ...
  else
  {
    ...
    else
    {
      ...
      {
        int const             row = itIn2.GetIndex()[0];
        int const             column = itIn2.GetIndex()[1];
        FloatImage::PixelType expected = 0.0f;
  ...
  itk::StreamingImageFilter<VectorImage, VectorImage>::Pointer const vectorStream =
  ...
  else
  {
    ...
    else
    {
      ...
      {
        int const             row = itIn3.GetIndex()[0];
        int const             column = itIn3.GetIndex()[1];
        FloatImage::PixelType expected = 0.0f;
