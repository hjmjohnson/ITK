...
itkBSplineScatteredDataPointSetToImageFilterTest4(int, char *[])
{
  ...
  VectorImageType::PointType const origin{};
  ...
  OutputPointType const outputPoint = transform->TransformPoint(inputPoint);
  ...
  RealType const testDistance = vector.GetNorm();
  RealType const approximateDistance = inputPoint.EuclideanDistanceTo(outputPoint);
