...
itkResampleImageTest2(int argc, char * argv[])
{
  ...
  bool const useReferenceImage = std::stoi(argv[7]);
  ...
  else
  {
    ...
    typename ImageType::DirectionType const outputDirection = resample->GetInput()->GetDirection();

    typename ImageType::PointType const outputOrigin = resample->GetInput()->GetOrigin();
