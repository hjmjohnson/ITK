...
itkBasicArchitectureTest(int, char *[])
{
  ...
  unsigned long const endEventObserverTag = shrink->AddObserver(itk::EndEvent(), end);
  ...
  unsigned long const anyEventObserverTag = shrink->AddObserver(itk::AnyEvent(), allEvents);
