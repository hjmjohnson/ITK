...
itkResampleImageTest7(int, char *[])
{
  ...
  ImageSizeType const    size = { { 64, 64 } };
  ...
  ImagePointerType const outputNoSDI = streamer->GetOutput(); // save output for later comparison
  ...
  ImagePointerType const outputSDI = streamer->GetOutput();
