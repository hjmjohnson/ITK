...
itkBSplineScatteredDataPointSetToImageFilterTest2(int argc, char * argv[])
{
  ...
  FilterType::RealType const bSplineEpsilon = 1e-4;
  ...
  FilterType::WeightsContainerType::Pointer const pointWeights = FilterType::WeightsContainerType::New();

  unsigned int const abritrarySize = filter->GetInput()->GetNumberOfPoints() - 1;
