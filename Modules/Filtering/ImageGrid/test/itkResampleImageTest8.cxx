...
itkResampleImageTest8(int, char *[])
{
  ...
  InputImagePointerType const inputImage = InputImageType::New();
  InputImageIndexType         inputIndex = { { 0, 0 } };
  InputImageSizeType const    inputSize = { { 18, 12 } };
  InputImageRegionType const  inputRegion{ inputIndex, inputSize };
  ...
  OutputImageSizeType const outputSize = { { 18, 12, 5 } };
  ...
  itk::ResampleImageFilter<InputImageType, OutputImageType>::Pointer const resample =
  ...
  OutputImageType::PointType const origin{};
