...
BSpline(int argc, char * argv[])
{
  ...
  typename ScalarFieldType::PointType const origin{};
  ...
  typename BSplinerType::ArrayType::ValueType const closeDimensionVal = 0;
  ...
  typename BSplinerType::ArrayType const splineOrder(3);
  ...
  typename BSplinerType::DirectionType const direction = reader->GetOutput()->GetDirection();
  ...
  typename BSplinerType::ControlPointLatticeType::Pointer const refinedControlPointLattice =
