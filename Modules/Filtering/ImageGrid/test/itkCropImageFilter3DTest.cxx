...
itkCropImageFilter3DTest(int, char *[])
{
  ...
  ImageType::RegionType::SizeType const  size = { { dimSize, dimSize, dimSize } };
  ImageType::RegionType::IndexType const index = { { 0, 0, 0 } };
  region.SetSize(size);
  ...
  itk::CropImageFilter<ImageType, ImageType>::Pointer const cropFilter =
  ...
  ImageType::SizeType const extractSize = { { 1, 1, 1 } };
  ...
  ImageType::Pointer const croppedImage = cropFilter->GetOutput();
  ...
  ImageType::RegionType::SizeType const  subSize = { { dimSize - 2, dimSize - 2, dimSize - 2 } };
  ImageType::RegionType::IndexType const subIndex = { { 1, 1, 1 } };
