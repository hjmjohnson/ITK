...
itkPasteImageFilterTest(int argc, char * argv[])
{
  ...
  itk::ImageFileReader<ImageType>::Pointer const dest = itk::ImageFileReader<ImageType>::New();

  dest->SetFileName(argv[1]);

  itk::ImageFileReader<ImageType>::Pointer const src = itk::ImageFileReader<ImageType>::New();
