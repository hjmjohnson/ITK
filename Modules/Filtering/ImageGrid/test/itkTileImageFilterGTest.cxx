...
protected:
  ...
  {
    const static unsigned int Dimension = TImage::ImageDimension;
...
TEST_F(TileImageFixture, SetGetPrint)
{
  ...
  Utils::FilterType::LayoutArrayType const layout(99);
...
TEST_F(TileImageFixture, VectorImage)
{
  ...
  typename ImageType::SizeType const imageSize = itk::MakeSize(10, 10);
