           ...
           unsigned int                             nImages)
{
  ...
  int const                        d = TVectorImage::SizeType::Dimension;
...
{
  std::string                     ans = "";
  unsigned int const              nImages = img->GetVectorLength();
...
itkExpandImageFilterTest2(int, char *[])
{
  ...
  // by 2.
  VectorImage1D::SizeType const size1D = { { 5 } };

  VectorImage1D::Pointer const input1D = GetVectorTestImage<VectorImage1D>(size1D, 2);
  ...
  expander1D->Update();
  VectorImage1D::Pointer const output1D = expander1D->GetOutput();
  ...
  VectorImage3D::SizeType const size3D = { { 3, 3, 3 } };
  VectorImage3D::Pointer const  input3D = GetVectorTestImage<VectorImage3D>(size3D, 4);
  ...
  VectorImage3D::Pointer const output3D = expander3D->GetOutput();
