...
PasteImageFilter<TInputImage, TSourceImage, TOutputImage>::GenerateInputRequestedRegion()
{
  ...
  InputImagePointer const  destPtr = const_cast<InputImageType *>(this->GetInput());
  SourceImagePointer const sourcePtr = const_cast<SourceImageType *>(this->GetSourceImage());
  ...
  const OutputImageRegionType & outputRegionForThread)
{
  ...
  InputImageSizeType const destinationSize = this->GetPresumedDestinationSize();
  ...
  else if (useOnlySource)
  {
    ...
    {
      SourceImagePixelType const sourceValue = this->GetConstant();
