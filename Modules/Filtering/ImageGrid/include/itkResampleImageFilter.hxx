  ...
  InitializeTransform()
{
  ...
  typename IdentityTransformType::Pointer const defaultTransform =
  ...
  BeforeThreadedGenerateData()
{
  ...
  if (nComponents == 0)
  {
    PixelComponentType const tempZeroComponents{ 0 };
    PixelComponentType const zeroComponent = NumericTraits<PixelComponentType>::ZeroValue(tempZeroComponents);
  ...
  LinearThreadedGenerateData(const OutputImageRegionType & outputRegionForThread)
{
  ...
  PixelType const defaultValue = this->GetDefaultPixelValue();
