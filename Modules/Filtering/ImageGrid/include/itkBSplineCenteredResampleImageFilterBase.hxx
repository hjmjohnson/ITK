...
void
BSplineCenteredResampleImageFilterBase<TInputImage, TOutputImage>::PrintSelf(std::ostream & os, Indent indent) const
{
...
template <typename TInputImage, typename TOutputImage>
void
BSplineCenteredResampleImageFilterBase<TInputImage, TOutputImage>::InitializePyramidSplineFilter(int SplineOrder)
{
  switch (SplineOrder)
  {
    case 1:
                                                                                 ...
                                                                                 ProgressReporter & progress)
{
  ...
  SizeValueType const inModK = 2L * inTraverseSize; // number for modulus math of in
  ...
  {
    IndexValueType const i1 = 2 * outK;
