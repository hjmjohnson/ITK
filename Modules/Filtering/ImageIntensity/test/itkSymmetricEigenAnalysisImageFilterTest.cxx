...
{ // using OutputPixelType = unsigned char;
  ...
  OutputImageType::Pointer const outputImage = OutputImageType::New();
...
public:
  ...
  Exercise(itk::EigenValueOrderEnum order, std::string outputFilename)
  {
    ...
    typename InternalImageType::Pointer const internalImage = filter->GetOutput();
...
public:
  ...
  Exercise(itk::EigenValueOrderEnum order, std::string outputFilename)
  {
    ...
    // Create the filter
    typename SymmetricEigenAnalysisFixedDimensionImageFilterType::Pointer const filter =
...
itkSymmetricEigenAnalysisImageFilterTest(int argc, char * argv[])
{
  ...
  int const testFixedDimensionResult =
