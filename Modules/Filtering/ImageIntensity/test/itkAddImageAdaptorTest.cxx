...
itkAddImageAdaptorTest(int, char *[])
{
  ...
  PixelType const additiveConstant = 19;
  ...
  ImageType::Pointer const diffImage = diffFilter->GetOutput();
  ...
  while (!dt.IsAtEnd())
  {
    ...
    RealPixelType const diff = itk::Math::abs(v1 - v2);
