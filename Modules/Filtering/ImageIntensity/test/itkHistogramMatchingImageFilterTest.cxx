...
CompareImages(itk::ImageRegionIterator<ImageType> & refIter, itk::ImageRegionIterator<ImageType> & outIter)
{
  ...
  {
    typename ImageType::PixelType const diff = refIter.Get() - outIter.Get();
...
itkHistogramMatchingImageFilterTest()
{
  ...
  // value for other tests
  {
    ...
    bool const generateReferenceHistogramFromImage = true;
    ...
    itk::SizeValueType const numberOfHistogramLevels = 50;
    ...
    itk::SizeValueType const numberOfMatchPoints = 8;
...

    {
      ...
      bool const thresholdAtMeanIntensity = false;
    ...
    }
    {
      ...
      bool const thresholdAtMeanIntensity = true;
      ITK_TEST_SET_GET_BOOLEAN(filterWithReferenceImage, ThresholdAtMeanIntensity, thresholdAtMeanIntensity);
