...
itkMaskNegatedImageFilterTest(int, char *[])
{
  ...
  // Test named mutator/accessors
  {
    ...
    myFilterType::MaskImageType::ConstPointer const retrievedMask = filter->GetMaskImage();
  ...
  myVectorImageType::PixelType const outsideValue = vectorFilter->GetOutsideValue();
  ...
  myVectorImageType::PixelType const outsideValue3 = vectorFilter->GetOutsideValue();
