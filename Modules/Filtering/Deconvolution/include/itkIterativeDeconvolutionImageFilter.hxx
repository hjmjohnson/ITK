  ...
  GenerateInputRequestedRegion()
{
  ...
  if (this->GetInput())
  {
    typename InputImageType::Pointer const imagePtr = const_cast<InputImageType *>(this->GetInput());
...
IterativeDeconvolutionImageFilter<TInputImage, TKernelImage, TOutputImage, TInternalPrecision>::GenerateData()
{
  ...
  float const iterationWeight = 0.8f / static_cast<float>(m_NumberOfIterations);
