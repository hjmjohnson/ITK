...
itkParametricBlindLeastSquaresDeconvolutionImageFilterTest(int argc, char * argv[])
{
  ...
  double const alpha = std::stod(argv[4]);
  double const beta = std::stod(argv[5]);
  ...
  KernelSourceType::ParametersValueType const expectedSigmaX = 2.90243;
  ...
  KernelSourceType::ParametersValueType const expectedSigmaY = 2.90597;
