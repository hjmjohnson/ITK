...
itkVectorAnisotropicDiffusionImageFilterTest(int itkNotUsed(argc), char * itkNotUsed(argv)[])
{
  try
  {
    ...
    itk::VectorGradientAnisotropicDiffusionImageFilter<ImageType, ImageType>::Pointer const filter =
    ...
    itk::VectorCurvatureAnisotropicDiffusionImageFilter<ImageType, ImageType>::Pointer const filter2 =
