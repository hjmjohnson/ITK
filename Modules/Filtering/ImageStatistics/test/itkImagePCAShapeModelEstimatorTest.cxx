...
itkImagePCAShapeModelEstimatorTest(int, char *[])
{
  ...
  unsigned int const numEigVal = eigenValues.size();
  ...
  // Print the MeanImage
  OutputImageType::Pointer const outImage = applyPCAShapeEstimator->GetOutput(0);
  ...
  {
    OutputImageType::Pointer const outImage2 = applyPCAShapeEstimator->GetOutput(j);
