  ...
  const OutputImageRegionType & outputRegionForThread)
{
  ...
  typename TInputImage::RegionType const inputRegion = inputImage->GetLargestPossibleRegion();
  ...
  SizeValueType const projectionSize = inputSize[m_ProjectionDimension];
