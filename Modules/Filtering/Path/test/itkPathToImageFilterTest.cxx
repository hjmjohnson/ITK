...
itkPathToImageFilterTest(int, char *[])
{
  ...
  // Set up the path
  auto path = PolyLineParametricPathType::New();
  ...
  ImageType::Pointer const image = pathToImageFilter->GetOutput();
