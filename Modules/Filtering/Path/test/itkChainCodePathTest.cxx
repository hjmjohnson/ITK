...
itkChainCodePathTest(int, char *[])
{
  ...
  ITK_EXERCISE_BASIC_OBJECT_METHODS(path, ChainCodePath, Path);
  ...
  offset[0] = 0;
  offset[1] = 1;
  path->InsertStep(0, offset);
  offset[0] = 1;
  offset[1] = 1;
  path->InsertStep(1, offset);
  offset[0] = 1;
  offset[1] = 0;
  path->InsertStep(2, offset);
  offset[0] = 1;
  offset[1] = -1;
  path->InsertStep(3, offset);
  offset[0] = 0;
  offset[1] = -1;
  path->InsertStep(4, offset);
  offset[0] = -1;
  offset[1] = -1;
  path->InsertStep(5, offset);
  offset[0] = -1;
  offset[1] = 0;
  path->InsertStep(6, offset);
  offset[0] = -1;
  offset[1] = 1;
  ...
  PathType::InputType const endOfInput = path->EndOfInput();
