                         ...
                         std::string                                                           name)
{
  ...
  {
    itkContourExtractor2DImageFilterTestNamespace::ExtractorType::VertexListConstPointer const vertices =
...
itkContourExtractor2DImageFilterTest(int argc, char * argv[])
{
  ...
  itkContourExtractor2DImageFilterTestNamespace::ReaderType::Pointer const reader =
    itkContourExtractor2DImageFilterTestNamespace::ReaderType::New();

  reader->SetFileName(argv[1]);
  itkContourExtractor2DImageFilterTestNamespace::ExtractorType::Pointer const extractor =
  ...
  try
  {
    ...
    itkContourExtractor2DImageFilterTestNamespace::ImageType::RegionType const region =
