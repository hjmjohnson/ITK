...
itkOrthogonalSwath2DPathFilterTest(int, char *[])
{
  ...
  ChainCodeToFourierSeriesPathFilterType::Pointer const chainCodeToFourierSeriesPathFilter =
  ...
  size[0] = 128;
  size[1] = 128;
  UCharImageType::RegionType const region{ start, size };
  ...
  double const gaussianVariance = 1.0;
  ...
  OutputPathType::Pointer const outPath = orthogonalSwath2DPathFilter->GetOutput();

  // Set up the input & output path images
  FourierSeriesPathToImageFilterType::Pointer const fourierSeriesPathToImageFilter =
    FourierSeriesPathToImageFilterType::New();
  OrthogonallyCorrected2DParametricPathToImageFilterType::Pointer const
  ...
  UCharImageType::Pointer const inputPathImage = fourierSeriesPathToImageFilter->GetOutput();
  UCharImageType::Pointer const outputImage = orthogonallyCorrected2DParametricPathToImageFilter->GetOutput();
  ...
  UCharImageType::Pointer const swathMeritImage = rescaleIntensityImageFilter->GetOutput();
