...
itkBinaryImageToStatisticsLabelMapFilterTest1(int argc, char * argv[])
{
  ...
  int const inputForegroundValue = (std::stoi(argv[5]));
  ...
  unsigned int const outputBackgroundValue = (std::stoi(argv[6]));
  ...
  bool const computeFeretDiameter = (std::stoi(argv[7]));
  ...
  bool const computePerimeter = std::stoi(argv[8]);
  ...
  bool const computeHistogram = (std::stoi(argv[9]));
  ...
  unsigned int const numberOfBins = (std::stoi(argv[10]));
  ...
  itk::SimpleFilterWatcher const watcher2(l2i);
