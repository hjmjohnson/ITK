...
TEST_F(StatisticsLabelMapFixture, 2D_zero)
{
  ...
  Utils::LabelPixelType const label = 1;
  labelImage->FillBuffer(label);


  Utils::LabelObjectType::ConstPointer const labelObject = Utils::ComputeLabelObject(labelImage, image, 1, 1 << 8);
...
TEST_F(StatisticsLabelMapFixture, 2D_ones_with_outliers)
{
  ...
  Utils::LabelObjectType::ConstPointer const labelObject = Utils::ComputeLabelObject(labelImage, image, label, 1 << 16);
...
TEST_F(StatisticsLabelMapFixture, 2D_even)
{
  ...
  Utils::LabelObjectType::ConstPointer const labelObject = Utils::ComputeLabelObject(labelImage, image, label, 1 << 8);
