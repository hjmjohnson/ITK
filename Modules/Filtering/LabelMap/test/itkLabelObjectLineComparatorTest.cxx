...
itkLabelObjectLineComparatorTest(int, char *[])
{
  ...
  LabelObjectLineType const low(lowIndex, 11);
  LabelObjectLineType const high(highIndex, 11);
  LabelObjectLineType const lowlong(lowIndex, 15);
