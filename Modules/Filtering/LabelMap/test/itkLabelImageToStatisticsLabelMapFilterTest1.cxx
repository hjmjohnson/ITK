...
itkLabelImageToStatisticsLabelMapFilterTest1(int argc, char * argv[])
{
  ...
  int const BackgroundValue = (std::stoi(argv[4]));
  ...
  bool const computeFeretDiameter = (std::stoi(argv[5]));
  ...
  bool const computePerimeter = std::stoi(argv[6]);
  ...
  bool const computeHistogram = (std::stoi(argv[7]));
  ...
  unsigned int const numberOfBins = (std::stoi(argv[8]));
