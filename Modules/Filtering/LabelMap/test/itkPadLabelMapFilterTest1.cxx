...
itkPadLabelMapFilterTest1(int argc, char * argv[])
{
  ...
  PadLabelMapFilterType::SizeType const upperBoundaryPadSize = { { 0 } };
  ...
  PadLabelMapFilterType::SizeType const lowerBoundaryPadSize = { { 0 } };
  ...
  itk::SimpleFilterWatcher const watcher(padLabelMapFilter, "filter");
