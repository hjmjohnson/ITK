...
InPlaceLabelMapFilter<TInputImage>::AllocateOutputs()
{
  ...
  if (this->m_InPlace && this->CanRunInPlace())
  {
    ...
    //
    OutputImagePointer const inputAsOutput = const_cast<TInputImage *>(this->GetInput());
    ...
    if (inputAsOutput)
    {
      ...
      RegionType const region = this->GetOutput()->GetLargestPossibleRegion();
    ...
    {
      OutputImagePointer const outputPtr = this->GetOutput(i);
