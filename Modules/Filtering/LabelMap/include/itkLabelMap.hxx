...
LabelMap<TLabelObject>::SetPixel(const IndexType & idx, const LabelType & iLabel)
{
  ...
  while (it != m_LabelObjectContainer.end())
  {
    ...
    if (it->first != iLabel)
    {
      auto tempIt = it;
      ++it;
      bool const emitModifiedEvent = (iLabel == m_BackgroundValue);
                                 ...
                                 const LabelType &                    label)
{
  ...
  else
  {
    ...
    LabelObjectPointerType const labelObject = LabelObjectType::New();
...
LabelMap<TLabelObject>::PushLabelObject(LabelObjectType * labelObject)
{
  ...
  {
    LabelType const lastLabel = m_LabelObjectContainer.rbegin()->first;
    LabelType const firstLabel = m_LabelObjectContainer.begin()->first;
