...
itkCompositeValleyFunctionTest(int, char *[])
{
  ...
  double const interval1 = function.GetInterval();
  double const interval2 = (function.GetUpperBound() - function.GetLowerBound()) / (1000000.0 - 1.0);
  ...
  long const   numberOfSamples = function.GetNumberOfSamples();
  double const measure = function.GetLowerBound() + interval1 * numberOfSamples * 0.5;
  double const value1 = function(measure);
  double const value2 = function.Evaluate(measure);
