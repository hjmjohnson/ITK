...
itkContourDirectedMeanDistanceImageFilterTest(int, char *[])
{
  ...
  // Compute the directed Mean distance h(image1,image2)
  {
    ...
    FilterType::RealType const trueDistance = 8.37831;
    FilterType::RealType const distance = filter->GetContourDirectedMeanDistance();
  ...
  // Compute the directed Mean distance h(image2,image1)
  {
    ...
    // Check results
    FilterType::RealType const trueDistance = 4.2053;
    FilterType::RealType const distance = filter->GetContourDirectedMeanDistance();
