...
itkDirectedHausdorffDistanceImageFilterTest2(int argc, char * argv[])
{
  ...
  typename ImageType::Pointer const image1 = reader1->GetOutput();
  filter->SetInput1(image1);
  ITK_TEST_SET_GET_VALUE(image1, filter->GetInput1());

  typename ImageType::Pointer const image2 = reader2->GetOutput();
  ...
  double const expecteDirectedHausdorffDistance = 0;
  ITK_TEST_EXPECT_EQUAL(expecteDirectedHausdorffDistance, filter->GetDirectedHausdorffDistance());

  double const expecteAverageHausdorffDistance = 0;
