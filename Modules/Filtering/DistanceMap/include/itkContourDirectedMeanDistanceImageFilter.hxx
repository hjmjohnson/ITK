...
ContourDirectedMeanDistanceImageFilter<TInputImage1, TInputImage2>::GenerateInputRequestedRegion()
{
  ...
  if (this->GetInput1())
  {
    InputImage1Pointer const image1 = const_cast<InputImage1Type *>(this->GetInput1());
    image1->SetRequestedRegionToLargestPossibleRegion();

    if (this->GetInput2())
    {
      InputImage2Pointer const image2 = const_cast<InputImage2Type *>(this->GetInput2());
...
ContourDirectedMeanDistanceImageFilter<TInputImage1, TInputImage2>::AllocateOutputs()
{
  ...
  InputImage1Pointer const image = const_cast<TInputImage1 *>(this->GetInput1());
  ...
  ThreadIdType       threadId)
{
  ...
  InputImage1ConstPointer const input = this->GetInput();
  ...
  FaceListType const faceList = bC(input, outputRegionForThread, radius);
