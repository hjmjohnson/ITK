                                                         ...
                                                         const FloatOffsetType &  offset) -> PixelType
{
  ...
  PixelType const update = this->CurvatureFlowFunctionType::ComputeUpdate(it, globalData, offset);
  ...
  PixelType const                           avgValue = innerProduct(it, this->m_StencilOperator);
