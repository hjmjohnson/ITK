...
BinaryThinningImageFilter<TInputImage, TOutputImage>::BinaryThinningImageFilter()
{
  ...
  OutputImagePointer const thinImage = OutputImageType::New();
...
BinaryThinningImageFilter<TInputImage, TOutputImage>::PrepareData()
{
  ...
  OutputImagePointer const thinImage = GetThinning();
  ...
  typename OutputImageType::RegionType const region = thinImage->GetRequestedRegion();
...
BinaryThinningImageFilter<TInputImage, TOutputImage>::ComputeThinImage()
{
  ...
  OffsetType const o2 = { { 0, -1 } };
  OffsetType const o3 = { { 1, -1 } };
  OffsetType const o4 = { { 1, 0 } };
  OffsetType const o5 = { { 1, 1 } };
  OffsetType const o6 = { { 0, 1 } };
  OffsetType const o7 = { { -1, 1 } };
  OffsetType const o8 = { { -1, 0 } };
  OffsetType const o9 = { { -1, -1 } };
    ...
    for (int step = 1; step <= 4; ++step)
    {
      ...
      for (ot.GoToBegin(); !ot.IsAtEnd(); ++ot)
      {
        ...
        if (ot.GetCenterPixel())
        {
          ...
          PixelType const numberOfOnNeighbors = p2 + p3 + p4 + p5 + p6 + p7 + p8 + p9;
