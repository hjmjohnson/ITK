...
itkHessianToObjectnessMeasureImageFilterTest(int argc, char * argv[])
{
  ...
  bool const scaleObjectnessMeasure = false;
  ...
  if (argc >= 3)
  {
    unsigned int const objectDimension = std::stoi(argv[3]);
