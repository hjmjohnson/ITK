...
itkCannyEdgeDetectionImageFilterTest(int argc, char * argv[])
{
  ...
  CannyEdgeDetectionImageFilterType::OutputImagePixelType const upperThreshold = 30;
  filter->SetUpperThreshold(upperThreshold);
  ITK_TEST_SET_GET_VALUE(upperThreshold, filter->GetUpperThreshold());

  CannyEdgeDetectionImageFilterType::OutputImagePixelType const lowerThreshold = 15;
