...
itkHoughTransform2DCirclesImageTest(int, char *[])
{
  ...
  bool const useImageSpacing = false;
  ...
  double const radiusTolerance = 2.0;
  ...
  HoughImageType::ConstPointer const radiusImage = houghFilter->GetRadiusImage();
  ...
  do
  {
    ...
    for (it_input.GoToBegin(); !it_input.IsAtEnd(); ++it_input)
    {
      ...
      {
        it_output.Set(255);
        double const radius2 = radiusImage->GetPixel(it_output.GetIndex());
  ...
  double const centerTolerance = 2.0;
