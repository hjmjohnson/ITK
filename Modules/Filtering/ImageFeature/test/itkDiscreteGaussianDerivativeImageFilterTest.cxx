...
itkDiscreteGaussianDerivativeImageFilterTest(int argc, char * argv[])
{
  ...
  itk::SimpleFilterWatcher const watcher(derivativeFilter, "DiscreteGaussianDerivativeImageFilter");
  ...
  double const sigma = std::stod(argv[5]);
  ...
  bool const normalizeAcrossScale = false;
  ITK_TEST_SET_GET_BOOLEAN(derivativeFilter, NormalizeAcrossScale, normalizeAcrossScale);

  unsigned int const internalNumberOfStreamDivisions = DerivativeFilterType::InputImageType::GetImageDimension() *
