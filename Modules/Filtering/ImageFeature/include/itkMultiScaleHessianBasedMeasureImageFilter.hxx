...
MultiScaleHessianBasedMeasureImageFilter<TInputImage, THessianImage, TOutputImage>::GenerateData()
{
  ...
  {
    typename ScalesImageType::Pointer const scalesImage =
  ...
  {
    typename HessianImageType::Pointer const hessianImage =
    ...
    // make sure.
    typename HessianImageType::PixelType const zeroTensor(0.0);
  ...
  OutputRegionType const                outputRegion = this->GetOutput()->GetBufferedRegion();
