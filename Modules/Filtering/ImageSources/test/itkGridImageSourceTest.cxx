...
itkGridImageSourceTest(int argc, char * argv[])
{
  ...
  bool const toggleLastGridDimension = std::stod(argv[9]);
  ...
  if (useBSplineKernel)
  {
    unsigned int const bSplineOrder = std::stoi(argv[11]);
  ...
  itk::SimpleFilterWatcher const watcher(gridImage, "GridImageSource");
