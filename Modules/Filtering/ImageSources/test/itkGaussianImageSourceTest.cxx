...
itkGaussianImageSourceTest(int argc, char * argv[])
{
  ...
  ImageType::RegionType const region(startIndex, referenceSize);
  ...
  bool const useReferenceImage = true;
  ...
  bool const normalized = std::stoi(argv[2]) != 0;
  ...
  itk::SimpleFilterWatcher const watcher(gaussianImage, "GaussianImageSource");
  ...
  ImageType::Pointer const outputImage = gaussianImage->GetOutput();
