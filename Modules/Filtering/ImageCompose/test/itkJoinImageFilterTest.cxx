...
itkJoinImageFilterTest(int, char *[])
{
  ...
  myFilterType::OutputImageType::Pointer const outputImage = filter->GetOutput();
  ...
  myFilterType3::OutputImageType::Pointer const outputImage123 = filter123->GetOutput();
  ...
  myFilterType1::OutputImageType::Pointer const outputImage1 = filter1->GetOutput();
  ...
  // Create an iterator for going through the image output
  myFilterType2::OutputImageType::Pointer const outputImage2 = filter2->GetOutput();
  ...
  // Create an iterator for going through the image output
  myFilterType4::OutputImageType::Pointer const outputImage4 = filter4->GetOutput();
