...
itkSaltAndPepperNoiseImageFilterTest(int argc, char * argv[])
{
  ...
  PixelType const pepperValue = 10;
  ...
  itk::SimpleFilterWatcher const watcher(saltAndPepperNoiseImageFilter, "SaltAndPepperNoiseImageFilter");
