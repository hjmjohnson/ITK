                                               ...
                                               unsigned int                           numDimensions)
{
  ...
  typename TGradImage1DType::PixelType::ValueType const tolerance = 1e-5;
  ...
  while (!scalarIt.IsAtEnd() && !vector2DIt.IsAtEnd())
  {
    ...
    for (unsigned int d = 0; d < numDimensions; ++d)
    {
      ...
      {
        typename TGradImage1DType::PixelType::ValueType const truth = scalar[d] / (c + 1.0);
        typename TGradImage1DType::PixelType::ValueType const test = vector[d + (c * numDimensions)];
