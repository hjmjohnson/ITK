...
ConstantVelocityFieldTransform<TParametersValueType, VDimension>::IntegrateVelocityField()
{
  ...
  ConstantVelocityFieldPointer const constantVelocityField = this->GetModifiableConstantVelocityField();
...
ConstantVelocityFieldTransform<TParametersValueType, VDimension>::InternalClone() const
{
  ...
  typename DisplacementFieldType::ConstPointer const dispField = nonConstThis->GetDisplacementField();
  typename DisplacementFieldType::Pointer const      cloneDispField = this->CopyDisplacementField(dispField);
  ...
  typename DisplacementFieldType::ConstPointer const invDispField = nonConstThis->GetInverseDisplacementField();
  typename DisplacementFieldType::Pointer const      cloneInvDispField = this->CopyDisplacementField(invDispField);
  ...
  ConstantVelocityFieldInterpolatorPointer const newInterp = dynamic_cast<ConstantVelocityFieldInterpolatorType *>(
