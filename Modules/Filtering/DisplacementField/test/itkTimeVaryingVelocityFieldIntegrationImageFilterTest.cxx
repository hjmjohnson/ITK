...
itkTimeVaryingVelocityFieldIntegrationImageFilterTest(int argc, char * argv[])
{
  ...
  size[2] = 401;
  size[3] = 61;
  ImportFilterType::IndexType const start{};

  ImportFilterType::RegionType const region{ start, size };
  ...
  double const spaceTimeSpan[4] = { 20., 20., 20., 1.5 };
  ...
  TimeVaryingVelocityFieldType::Pointer const timeVaryingVelocityField = importFilter->GetOutput();
