...
itkTimeVaryingVelocityFieldTransformTest(int, char *[])
{
  ...
  TimeVaryingVelocityFieldType::PointType const origin{};
  ...
  DisplacementFieldType::IndexType const index{};
  ...
  TransformType::Pointer const clone = transform->Clone();
  ...
  InverseTransformBasePointer const inverseTransform = transform->GetInverseTransform();
  InverseTransformBasePointer const cloneInverseTransform = clone->GetInverseTransform();
