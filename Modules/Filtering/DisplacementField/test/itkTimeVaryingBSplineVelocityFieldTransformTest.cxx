...
itkTimeVaryingBSplineVelocityFieldTransformTest(int, char *[])
{
  ...
  TimeVaryingVelocityFieldControlPointLatticeType::Pointer const timeVaryingVelocityFieldControlPointLattice =
  ...
  {
    float const physicalDimensions = (size[d] - splineOrder) * spacing[d];
