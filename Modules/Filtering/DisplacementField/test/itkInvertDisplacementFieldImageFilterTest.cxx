...
itkInvertDisplacementFieldImageFilterTest(int argc, char * argv[])
{
  ...
  typename InverterType::RealType const maxErrorNorm = 0.0;
  ...
  VectorType const v = inverter->GetOutput()->GetPixel(index);
  VectorType const delta = v + ones;
