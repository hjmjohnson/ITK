...
itkDisplacementFieldToBSplineImageFilterTest(int, char *[])
{
  ...
  typename BSplineFilterType::OriginType::ValueType const bSplineDomainOriginVal = 0.0;
  ...
  typename BSplineFilterType::SpacingType::ValueType const bSplineDomainSpacingVal = 1.0;
  ...
  typename BSplineFilterType::SizeType::value_type const bSplineDomainSizeVal = 0;
