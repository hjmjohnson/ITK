...
itkFFTPadImageFilterTest(int argc, char * argv[])
{
  ...
  itk::SizeValueType const sizeGreatestPrimeFactor = std::stoi(argv[3]);
  ...
  std::string const padMethod = argv[4];
  if (padMethod == "Mirror")
  {
  ...
  itk::SimpleFilterWatcher const watchFFTPad(fftpad, "fftpad");
