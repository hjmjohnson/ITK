...
itkHalfToFullHermitianImageFilterTest(int argc, char * argv[])
{
  ...
  ComplexImageType::RegionType const halfToFullOutputRegion = halfToFullFilter->GetOutput()->GetLargestPossibleRegion();
  ComplexImageType::SizeType const   halfToFullOutputSize = halfToFullOutputRegion.GetSize();
  ...
  itk::ImageRegion<ComplexImageType::ImageDimension> const conjugateRegion(conjugateRegionIndex, conjugateRegionSize);
