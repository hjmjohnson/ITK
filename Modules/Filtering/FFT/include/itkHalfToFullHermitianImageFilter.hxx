  ...
  const OutputImageRegionType & outputRegionForThread)
{
  ...
  InputImageRegionType const  inputRegion = inputPtr->GetLargestPossibleRegion();
  ...
  bool const            copy = copyRegion.Crop(inputRegion);
  ...
  OutputImageSizeType const outputRegionSize = outputRegionForThread.GetSize();
  ...
  if (outputRegionMaximumIndex[0] > inputRegionMaximumIndex[0])
  {
    ...
    OutputImageRegionType const conjugateRegion(conjugateRegionIndex, conjugateRegionSize);
    ...
    for (oIt.GoToBegin(); !oIt.IsAtEnd(); ++oIt)
    {
      ...
      {
        OutputImageRegionType const outputLargestPossibleRegion = outputPtr->GetLargestPossibleRegion();
