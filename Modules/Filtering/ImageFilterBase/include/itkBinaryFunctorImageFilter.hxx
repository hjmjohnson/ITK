...
BinaryFunctorImageFilter<TInputImage1, TInputImage2, TOutputImage, TFunction>::GenerateOutputInformation()
{
  ...
  Input1ImagePointer const inputPtr1 = dynamic_cast<const TInputImage1 *>(ProcessObject::GetInput(0));
  Input2ImagePointer const inputPtr2 = dynamic_cast<const TInputImage2 *>(ProcessObject::GetInput(1));
