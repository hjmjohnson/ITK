...
template <typename TInputImage, typename TOutputImage>
void
VectorNeighborhoodOperatorImageFilter<TInputImage, TOutputImage>::DynamicThreadedGenerateData(
  const OutputImageRegionType & outputRegionForThread)
{
  ...
  VectorNeighborhoodInnerProduct<InputImageType> const smartInnerProduct;
  BFC                                                  faceCalculator;
  ...
  FaceListType const faceList = faceCalculator(input, outputRegionForThread, m_Operator.GetRadius());
