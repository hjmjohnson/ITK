...
TestCastFromTo()
{
  ...
  typename InputImageType::Pointer const randomSourceImagePtr = randomValuesImageSource->GetOutput();
  {
    typename InputImageType::IndexType const Index000{ { 0, 0, 0 } };
    typename InputImageType::IndexType const Index100{ { 1, 0, 0 } };
    typename InputImageType::IndexType const Index200{ { 2, 0, 0 } };
    typename InputImageType::IndexType const Index300{ { 3, 0, 0 } };
    typename InputImageType::IndexType const Index400{ { 4, 0, 0 } };
...
TestVectorImageCast1()
{
  ...
  itk::ImageRegion<2> const region(start, size);
...
itkCastImageFilterTest(int, char *[])
{
  ...
  bool const fpeSupport = itk::FloatingPointExceptions::HasFloatingPointExceptionsSupport();
  bool const fpeStatus = itk::FloatingPointExceptions::GetEnabled();
