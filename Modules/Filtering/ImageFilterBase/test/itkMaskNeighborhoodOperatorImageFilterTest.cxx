...
itkMaskNeighborhoodOperatorImageFilterTest(int argc, char * argv[])
{
  ...
  itk::ImageFileReader<InputImageType>::Pointer const input = itk::ImageFileReader<InputImageType>::New();
  ...
  unsigned int const width = size[0];
  ...
  // Generate test image
  itk::ImageFileWriter<OutputImageType>::Pointer const writer = itk::ImageFileWriter<OutputImageType>::New();
