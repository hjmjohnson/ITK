...
itkTestingComparisonImageFilterTest(int argc, char * argv[])
{
  ...
  unsigned long const numberOfPixelsWithDifferences = filter->GetNumberOfPixelsWithDifferences();
