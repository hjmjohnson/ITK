...
itkFastMarchingBaseTest(int argc, char * argv[])
{
  ...
  if (useMeshVsImage == 0)
  {
    ...
    typename ImageFastMarching::OutputPixelType const targetReachedValue{};
    ...
    ImageType::OffsetType const              offset = { { 28, 35 } };

    itk::Index<Dimension> const index{};
    ...
    [[maybe_unused]] OutputImageType::Pointer const output = fmm->GetOutput();
  }
  else if (useMeshVsImage == 1)
  {
    ...
    [[maybe_unused]] OutputMeshType::Pointer const output = fmm->GetOutput();
  }
