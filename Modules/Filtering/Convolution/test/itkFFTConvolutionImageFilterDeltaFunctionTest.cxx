...
itkFFTConvolutionImageFilterDeltaFunctionTest(int argc, char * argv[])
{
  ...
  ImageType::RegionType const region = reader->GetOutput()->GetLargestPossibleRegion();
  ...
  {
    ImageType::SizeValueType const sizeInDimension = region.GetSize()[i];
  ...
  ConvolutionFilterType::SizeValueType const sizeGreatestPrimeFactor = std::stoi(argv[3]);
