...
GenerateKernelForStreamingTest()
{
  ...
  KernelSizeType const kernelSize{ { 3, 5 } };
...
doConvolutionImageFilterStreamingTest(int argc, char * argv[])
{
  ...
  RegionType const requestedRegion(requestedIndex, requestedSize);
  ...
  KernelImageType::Pointer const kernelImage = GenerateKernelForStreamingTest();
