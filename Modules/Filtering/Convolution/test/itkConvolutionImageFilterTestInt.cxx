...
itkConvolutionImageFilterTestInt(int argc, char * argv[])
{
  ...
  itk::SimpleFilterWatcher const watcher(convolver, "filter");
  ...
  if (argc >= 6)
  {
    std::string const outputRegionMode(argv[5]);
  ...
  itk::StreamingImageFilter<ImageType, ImageType>::Pointer const streamingFilter =
