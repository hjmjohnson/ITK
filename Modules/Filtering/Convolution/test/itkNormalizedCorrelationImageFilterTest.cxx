...
itkNormalizedCorrelationImageFilterTest(int argc, char * argv[])
{
  ...
  // create a mask
  itk::ImageFileReader<InputImageType>::Pointer const mask = itk::ImageFileReader<InputImageType>::New();
  ...
  itk::SimpleFilterWatcher const watcher(filter, "Normalized correlation");
