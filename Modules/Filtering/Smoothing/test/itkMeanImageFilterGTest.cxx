...
TEST(MeanImageFilter, OutputSameAsInputForUniformImage)
{
  ...
  itk::VariableLengthVector<float> const v{ array, 3 };
...
TEST(MeanImageFilter, ExpectedOutputPixelValuesForSequenceOfNaturalNumbers)
{
