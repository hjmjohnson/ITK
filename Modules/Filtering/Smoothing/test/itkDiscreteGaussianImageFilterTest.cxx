...
itkDiscreteGaussianImageFilterTest(int argc, char * argv[])
{
  ...
  FilterType::SigmaArrayType::ValueType const sigmaValue = 1.0;
  ...
  unsigned int const maximumKernelWidth = 32;
