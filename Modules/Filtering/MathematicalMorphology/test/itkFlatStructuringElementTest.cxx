...
{
  int const  scalarRadius = 5;
  int const  scalarThickness = 2;
  bool const radiusIsParametric = true;
...
ComputeAreaError(const SEType & k, unsigned int thickness)
{
  ...
  float const expectedForegroundArea = expectedOuterForegroundArea - expectedInnerForegroundArea;
