...
itkOtsuThresholdCalculatorTest(int, char *[])
{
  ...
  unsigned long const numPixels = region.GetNumberOfPixels();

  using IteratorType = itk::ImageRegionIterator<ImageType>;
  IteratorType iter(image, image->GetBufferedRegion());

  ImageType::PixelType const value1 = 10;
  ImageType::PixelType const value2 = 50;
  ImageType::PixelType const range = 5;
  ImageType::PixelType const r2 = range * 2 + 1;
  ...
  double const thresholdResult = calculator->GetThreshold();
