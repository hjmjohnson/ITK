...
itkIntermodesMaskedThresholdImageFilterTest(int argc, char * argv[])
{
  ...
  unsigned long const maximumSmoothingIterations = std::stoi(argv[6]);
  ...
  bool const useInterMode = static_cast<bool>(std::stoi(argv[7]));
  ...
  FilterType::InputPixelType const expectedThreshold = std::stod(argv[8]);
