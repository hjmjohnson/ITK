...
itkBinaryThresholdImageFilterTest(int, char *[])
{
  ...
  // Set up ivars
  InputPixelType const lower = 64;
  InputPixelType const upper = 128;
  ...
  // Lower threshold
  FilterType::InputPixelObjectType::Pointer const lowerThreshold1 = filter->GetLowerThresholdInput();
  ...
  FilterType::InputPixelObjectType::Pointer const lowerThreshold2 = FilterType::InputPixelObjectType::New();
  ...
  // Upper threshold
  FilterType::InputPixelObjectType::Pointer const upperThreshold1 = filter->GetUpperThresholdInput();
  ...
  FilterType::InputPixelObjectType::Pointer const upperThreshold2 = FilterType::InputPixelObjectType::New();
