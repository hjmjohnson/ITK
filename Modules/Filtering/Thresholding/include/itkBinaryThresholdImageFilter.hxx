...
{
  typename InputPixelObjectType::Pointer const lower = const_cast<Self *>(this)->GetLowerThresholdInput();
...
{
  typename InputPixelObjectType::Pointer const upper = const_cast<Self *>(this)->GetUpperThresholdInput();
...
BinaryThresholdImageFilter<TInputImage, TOutputImage>::BeforeThreadedGenerateData()
{
  ...
  typename InputPixelObjectType::Pointer const lowerThreshold = this->GetLowerThresholdInput();
  typename InputPixelObjectType::Pointer const upperThreshold = this->GetUpperThresholdInput();
