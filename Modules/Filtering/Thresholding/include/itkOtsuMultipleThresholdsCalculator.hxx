...
{
  typename TInputHistogram::ConstPointer const histogram = this->GetInputHistogram();
...
OtsuMultipleThresholdsCalculator<TInputHistogram>::Compute()
{
  ...
  typename TInputHistogram::ConstIterator const end = histogram->End();
  ...
  SizeValueType const numberOfClasses = m_NumberOfThresholds + 1;
  ...
  SizeValueType const histSize = histogram->GetSize()[0];
