                                                                                    ...
                                                                                    LevelSetOutputRealType &       prod)
{
  ...
  LevelSetPointer const        levelSet = this->m_LevelSetContainer->GetLevelSet(this->m_CurrentLevelSetId);
  LevelSetOutputRealType const value = levelSet->Evaluate(iP);
...
template <typename TInput, typename TLevelSetContainer>
void
LevelSetEquationChanAndVeseExternalTerm<TInput, TLevelSetContainer>::UpdatePixel(
  const LevelSetInputIndexType & iP,
  ...
  const LevelSetOutputRealType & newValue)
{
  ...
  InputPixelType const input = this->m_Input->GetPixel(iP);
