...
DiscreteLevelSetImage<TOutput, VDimension>::EvaluateHessian(const InputType & inputIndex, LevelSetDataType & data) const
{
  ...
  bool const backward = data.BackwardGradient.m_Computed;
  bool const forward = data.ForwardGradient.m_Computed;
...
DiscreteLevelSetImage<TOutput, VDimension>::EvaluateMeanCurvature(const InputType & inputIndex) const -> OutputRealType
{
  ...
  OutputRealType const gradNorm = grad.GetNorm();
                                                                  ...
                                                                  LevelSetDataType & data) const
{
  if (!data.MeanCurvature.m_Computed)
  {
    ...
    OutputRealType const temp = data.GradientNorm.m_Value;
