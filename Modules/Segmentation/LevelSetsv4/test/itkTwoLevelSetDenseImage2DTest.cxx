...
itkTwoLevelSetDenseImage2DTest(int argc, char * argv[])
{
  ...
  //
  InputImageType::RegionType const inputBufferedRegion = input->GetBufferedRegion();
  InputImageType::SizeType const   inputBufferedRegionSize = inputBufferedRegion.GetSize();
