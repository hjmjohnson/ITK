...
itkLevelSetEquationOverlapPenaltyTermTest(int, char *[])
{
  ...
  SparseLevelSetType::Pointer const level_set1 = adaptor1->GetModifiableLevelSet();
  SparseLevelSetType::Pointer const level_set2 = adaptor2->GetModifiableLevelSet();
  ...
  typename OverlapPenaltyTermType::LevelSetOutputRealType const coefficient = 1000.0;
  penaltyTerm1->SetCoefficient(coefficient);
  ITK_TEST_SET_GET_VALUE(coefficient, penaltyTerm1->GetCoefficient());

  typename OverlapPenaltyTermType::LevelSetIdentifierType const currentLevelSetId = 1;
  ...
  std::string const termName = "Overlap term";
