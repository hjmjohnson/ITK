...
itkBinaryImageToMalcolmSparseLevelSetAdaptorTest(int argc, char * argv[])
{
  ...
  LevelSetType::Pointer const sparseLevelSet = adaptor->GetModifiableLevelSet();
  ...
  LabelObjectPointer const labelObject = LabelObjectType::New();
  LabelObjectPointer const labelObjectSrc = sparseLevelSet->GetAsLabelObject<unsigned long>();
