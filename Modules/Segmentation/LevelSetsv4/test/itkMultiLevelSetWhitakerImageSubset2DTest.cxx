...
itkMultiLevelSetWhitakerImageSubset2DTest(int, char *[])
{
  ...
  using LevelSetType = itk::WhitakerSparseLevelSetImage<PixelType, Dimension>;
  ...
  adaptor1->Initialize();
  LevelSetType::Pointer const levelSet1 = adaptor1->GetModifiableLevelSet();
  ...
  bool const levelSetNotYetAdded = lscontainer->AddLevelSet(0, levelSet1, false);
