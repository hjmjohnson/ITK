...
itkLevelSetEquationLaplacianTermTest(int argc, char * argv[])
{
  ...
  typename LaplacianTermType::LevelSetOutputRealType const coefficient = 1.0;
  term->SetCoefficient(coefficient);
  ITK_TEST_SET_GET_VALUE(coefficient, term->GetCoefficient());

  typename LaplacianTermType::LevelSetIdentifierType const currentLevelSetId = 0;
  ...
  std::string const termName = "Laplacia term";
