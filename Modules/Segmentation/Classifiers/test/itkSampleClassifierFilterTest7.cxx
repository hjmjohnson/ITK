...
itkSampleClassifierFilterTest7(int argc, char * argv[])
{
  ...
  for (unsigned int i = 0; i < numberOfClasses; ++i)
  {
    ...
    {
      double const temp = (components[i])->GetFullParameters()[j] - trueParameters[i][j];
  ...
  PointSetType::PointsContainerPointer const pointsContainer2 = PointSetType::PointsContainer::New();
  ...
  unsigned int const numberOfSamplesPerClass = 100;
