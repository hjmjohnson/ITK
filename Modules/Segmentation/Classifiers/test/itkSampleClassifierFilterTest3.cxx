...
itkSampleClassifierFilterTest3(int, char *[])
{
  ...
  unsigned int const numberOfSampleEachClass = 10;
  ...
  unsigned int const bucketSize = 1;
  ...
  unsigned int const maximumIteration = 100;
  ...
  ClassLabelType const class1 = 0;
  classLabelVector.push_back(class1);

  ClassLabelType const class2 = 1;
  ...
  {
    FilterType::MembershipFunctionPointer const membershipFunction = *functionIter;
  ...
  FilterType::MembershipFunctionsWeightsArrayPointer const weightArrayObjects =
  ...
  unsigned int const numberOfClasses2 = 3;
