...
itkCollidingFrontsImageFilterTest(int argc, char * argv[])
{
  ...
  double const                  radius = seedPosition2[0] - offset[0];
  ...
  InternalImageType::Pointer const output = collidingFronts->GetOutput();
  ...
  for (; !iterator.IsAtEnd(); ++iterator)
  {
    ...
    InternalImageType::PixelType const outputPixel = iterator.Get();
