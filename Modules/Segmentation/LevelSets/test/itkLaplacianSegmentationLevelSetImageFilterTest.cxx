...
itkLaplacianSegmentationLevelSetImageFilterTest(int, char *[])
{
  ...
  LSIFTN::ImageType::Pointer const     inputImage = LSIFTN::ImageType::New();
  LSIFTN::SeedImageType::Pointer const seedImage = LSIFTN::SeedImageType::New();
  ...
  itk::LaplacianSegmentationLevelSetImageFilter<::LSIFTN::SeedImageType, ::LSIFTN::ImageType>::Pointer const filter =
