...
SimpleVelocity(const TPoint & p)
{
  ...
  double       value;
  double const x = p[0] - center[0];
  double const y = p[1] - center[1];
...
itkExtensionVelocitiesImageFilterTest(int, char *[])
{
  ...
  */
  ...
  ImageType::RegionType const centerRegion{ centerIndex, centerSize };
