  ...
  SparseImageType *       sparseImage) const
{
  ...
  {
    ValueType const distance = distanceImageIterator.Value();
...
SparseFieldFourthOrderLevelSetImageFilter<TInputImage, TOutputImage>::ProcessNormals()
{
  ...
  typename NormalVectorFilterType::Pointer const   NormalVectorFilter = NormalVectorFilterType::New();
  typename NormalVectorFunctionType::Pointer const NormalVectorFunction = NormalVectorFunctionType::New();
