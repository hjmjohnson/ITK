...
itkVoronoiPartitioningImageFilterTest(int argc, char * argv[])
{
  ...
  // Load an image
  itk::ImageFileReader<FloatImage>::Pointer const original = itk::ImageFileReader<FloatImage>::New();
  original->SetFileName(argv[1]);

  // Preprocess the image
  itk::DiscreteGaussianImageFilter<FloatImage, FloatImage>::Pointer const gaussian3 =
  ...
  double const sigmaThreshold = 4.0;
  ...
  itk::SimpleFilterWatcher const voronoiWatcher(voronoi);
