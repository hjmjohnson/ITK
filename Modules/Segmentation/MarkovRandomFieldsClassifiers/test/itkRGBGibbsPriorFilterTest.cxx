...
itkRGBGibbsPriorFilterTest(int, char *[])
{
  ...
  VecImageType::SizeType const vecImgSize = { { ImageWidth, ImageHeight, NumFrames } };
  ...
  ClassImageType::SizeType const classImgSize = { { ImageWidth, ImageHeight, NumFrames } };
  ...
  double const cliqueWeight1 = 5.0;
  ...
  double const cliqueWeight2 = 5.0;
  ...
  double const cliqueWeight3 = 5.0;
  ...
  double const cliqueWeight4 = 5.0;
  ...
  double const cliqueWeight5 = 5.0;
  ...
  double const cliqueWeight6 = 0.0;
  ...
  ClassImageType::Pointer const outClassImage = applyGibbsImageFilter->GetOutput();
