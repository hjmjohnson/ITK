...
itkTobogganImageFilterTest(int argc, char * argv[])
{
  ...
  const itk::ImageFileReader<InputImageType>::Pointer reader = itk::ImageFileReader<InputImageType>::New();
  ...
  auto gmgaussian = GMGaussianType::New();
  ...
  auto outputCaster = OutputCastFilterType::New();
