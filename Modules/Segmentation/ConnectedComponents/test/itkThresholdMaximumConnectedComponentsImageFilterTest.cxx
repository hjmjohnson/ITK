...
itkThresholdMaximumConnectedComponentsImageFilterTest(int argc, char * argv[])
{
  ...
  InputPixelType const maxLabel = itk::NumericTraits<InputPixelType>::max();
  InputPixelType const minLabel = itk::NumericTraits<InputPixelType>::NonpositiveMin();
  ...
  typename ThresholdType::PixelType const upperBoundary = itk::NumericTraits<ThresholdType::PixelType>::max();
