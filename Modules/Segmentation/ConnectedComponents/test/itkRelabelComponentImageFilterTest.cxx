...
itkRelabelComponentImageFilterTest(int argc, char * argv[])
{
  ...
  int const      NumBins = 13;
  RealType const LowerBound = 51.0;
  RealType const UpperBound = 252.0;
  ...
  itk::SimpleFilterWatcher const watcher(relabel);
  itk::SimpleFilterWatcher const statswatcher(statistics);
  ...
  itk::SizeValueType const numberOfObjectsToPrint = 5;
  ...
  unsigned long const ref1[7] = { 7656, 2009, 1586, 1491, 1454, 921, 906 };
  for (int i = 0; i < 6; ++i)
  {
  ...
  unsigned long const ref2[7] = { 1491, 2, 1, 906, 3, 40, 1 };
  for (int i = 0; i < 7; ++i)
  {
