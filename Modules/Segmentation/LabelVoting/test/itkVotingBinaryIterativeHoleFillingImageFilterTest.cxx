...
itkVotingBinaryIterativeHoleFillingImageFilterTest(int, char *[])
{
  ...
  ImageType::PixelType const foreground = 97; // prime numbers are good testers
  ImageType::PixelType const background = 29;
  ...
  unsigned int const maximumNumberOfIterations = 10;
  ...
  unsigned int const currentNumberOfIterations = 0;
