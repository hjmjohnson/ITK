                                         ...
                                         TDefaultRegistrationType>::GenerateData()
{
  ...
  DisplacementFieldPointer const inputPtr = const_cast<DisplacementFieldType *>(this->GetInput(0));
  ...
  else if (inputPtr)
  {
    ...
    typename FloatImageType::Pointer const fi = m_FixedImagePyramid->GetOutput(fixedLevel);
