...
public:
  ...
  GetValue(const ParametersType & parameters) const override
  {
    ...
    {
      PointType const transformedPoint = this->m_Transform->TransformPoint(*it);
...
itkImageToSpatialObjectRegistrationTest(int, char *[])
{
  ...
  itk::Statistics::NormalVariateGenerator::Pointer const generator = itk::Statistics::NormalVariateGenerator::New();
