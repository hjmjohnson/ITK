...
itkMultiResolutionImageRegistrationMethodTest(int, char *[])
{
  ...
  FixedImageType::RegionType const region(size);
  ...
  itk::SizeValueType const numberOfLevels = 2;
  ...
  typename ParametersType::ValueType const initialTransformParametersOfNextLevelVal(0.0);
  ParametersType const initialTransformParametersOfNextLevel(1, initialTransformParametersOfNextLevelVal);
