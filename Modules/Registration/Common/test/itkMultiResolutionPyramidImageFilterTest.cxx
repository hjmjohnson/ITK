...
itkMultiResolutionPyramidImageFilterTest(int argc, char * argv[])
{
   ...
   */
  using PyramidType = itk::MultiResolutionPyramidImageFilter<InputImageType, OutputImageType>;
  ...
  {
    pyramid = itk::RecursiveMultiResolutionPyramidImageFilter<InputImageType, OutputImageType>::New();
  }
  ...
  for (unsigned int testLevel = 0; testLevel < numLevels; ++testLevel)
  {
    ...
    OutputImageType::PointType const    InputCenterOfMass = GetCenterOfMass<OutputImageType>(pyramid->GetInput());
    ...
    OutputImageType::PointType const OutputCenterOfMass =
    ...
    {
      OutputImageType::PointType::VectorType const ErrorCenterOfMass = OutputCenterOfMass - InputCenterOfMass;
