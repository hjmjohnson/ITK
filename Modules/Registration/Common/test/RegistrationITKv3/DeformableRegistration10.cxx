...
main(int argc, char * argv[])
{
  ...
  FixedImageCasterType::Pointer const  fixedImageCaster = FixedImageCasterType::New();
  MovingImageCasterType::Pointer const movingImageCaster = MovingImageCasterType::New();

  fixedImageCaster->SetInput(fixedImageReader->GetOutput());
  movingImageCaster->SetInput(movingImageReader->GetOutput());

  using MatchingFilterType = itk::HistogramMatchingImageFilter<InternalImageType, InternalImageType>;
  MatchingFilterType::Pointer const matcher = MatchingFilterType::New();
  ...
  RegistrationFilterType::Pointer const filter = RegistrationFilterType::New();
  ...
  MultiResRegistrationFilterType::Pointer const multires = MultiResRegistrationFilterType::New();
  ...
  WarperType::Pointer const       warper = WarperType::New();
