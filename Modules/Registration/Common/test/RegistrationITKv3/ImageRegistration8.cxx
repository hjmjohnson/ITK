...
main(int argc, char * argv[])
{
  ...
  ResampleFilterType::Pointer const resampler = ResampleFilterType::New();
  ...
  RescalerType::Pointer const intensityRescaler = RescalerType::New();
  ...
  ExtractFilterType::Pointer const extractor = ExtractFilterType::New();
  extractor->SetDirectionCollapseToSubmatrix();
  extractor->InPlaceOn();

  FixedImageType::RegionType const inputRegion = fixedImage->GetLargestPossibleRegion();
  ...
  SliceWriterType::Pointer const sliceWriter = SliceWriterType::New();
