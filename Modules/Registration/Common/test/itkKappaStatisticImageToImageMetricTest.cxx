...
itkKappaStatisticImageToImageMetricTest(int, char *[])
{
  ...
  MetricType::RealType const foregroundValue = 255;
  ...
  TransformType::ParametersType const parameters = transform->GetParameters();
  ...
  double const expectedDerivativeMeasure = -0.0477502;
