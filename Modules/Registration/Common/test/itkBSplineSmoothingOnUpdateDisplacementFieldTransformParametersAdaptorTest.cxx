...
itkBSplineSmoothingOnUpdateDisplacementFieldTransformParametersAdaptorTest(int, char *[])
{
  ...
  SpacingType const spacingBefore = transform->GetDisplacementField()->GetSpacing();
  SizeType const    sizeBefore = transform->GetDisplacementField()->GetLargestPossibleRegion().GetSize();
  ...
  SpacingType const spacingAfter = transform->GetDisplacementField()->GetSpacing();
  SizeType const    sizeAfter = transform->GetDisplacementField()->GetLargestPossibleRegion().GetSize();
