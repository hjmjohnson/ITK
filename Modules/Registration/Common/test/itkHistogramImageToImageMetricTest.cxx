...
itkHistogramImageToImageMetricTest(int, char *[])
{
  ...
  MetricType::MeasurementVectorType const lowerBound{};
  MetricType::MeasurementVectorType const upperBound{};
  ...
  try
  {
    ParametersType const parameters2(2);
    DerivativeType       derivatives2(2);
    ScalesType const     badScales(1);
