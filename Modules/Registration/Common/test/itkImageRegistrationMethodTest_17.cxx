...
itkImageRegistrationMethodTest_17(int, char *[])
{
   ...
   **********************************************************/
  double const displacement[dimension] = { 3, 1, 1 };
  double const scale[dimension] = { 0.90, 1.0, 1.0 };
  ...
  unsigned int const     iter[numberOfLoops] = { 50, 0 };
  double const           rates[numberOfLoops] = { 1e-3, 5e-4 };
