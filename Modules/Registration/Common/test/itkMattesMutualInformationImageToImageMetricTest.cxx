                                    ...
                                    bool            useCachingBSplineWeights)
{
  ...
  itk::SizeValueType const numberOfHistogramBins = 50;
  ...
  if (useSampling)
  {
    ...
    // metric->SetNumberOfSpatialSamples( 500 );
    {
      ...
      typename ImageMaskSpatialObjectType::ConstPointer const soMovingConstMask = soMovingMask;
      typename ImageMaskSpatialObjectType::ConstPointer const soFixedConstMask = soFixedMask;
  ...
  //------------------------------------------------------------
  unsigned int const numberOfParameters = transformer->GetNumberOfParameters();
  ...
  for (unsigned int i = 0; i < numberOfParameters; ++i)
  {
    ...
    double const approxDerivative = (measurePlus - measureMinus) / (2 * delta);
    double const ratio = derivative[i] / approxDerivative;
                                     ...
                                     bool            useCachingBSplineWeights)
{
  ...
  typename MovingImageType::SizeType const   size = { { 100, 100 } };
  typename MovingImageType::IndexType const  index = { { 0, 0 } };
  typename MovingImageType::RegionType const region{ index, size };
  ...
  typename MetricType::MeasureType    measure2;
  typename MetricType::DerivativeType derivative(numberOfParameters);
  unsigned int const                  q = numberOfParameters / 4;
  ...
  double const delta = 0.1 * imgSpacing[0];
