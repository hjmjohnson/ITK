...
itkBSplineTransformParametersAdaptorTest(int, char *[])
{
  ...
  TransformType::SizeType const gridSizeBefore =
  ...
  ParametersType const fixedParameters = adaptor->GetRequiredFixedParameters();
  ...
  TransformType::SizeType const gridSizeAfter =
    transform->GetCoefficientImages()[0]->GetLargestPossibleRegion().GetSize();
