...
{
  double const diff = movingImageValue - this->m_FixedImageSamples[fixedImageSample].value;
  ...
  const ImageDerivativesType & movingImageGradientValue) const
{
  ...
  FixedImagePointType const fixedImagePoint = this->m_FixedImageSamples[fixedImageSample].point;
