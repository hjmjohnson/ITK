  ...
  BeforeThreadedGenerateData()
{
  ...
  FeaturePointsConstPointer const featurePoints = this->GetFeaturePoints();
  if (featurePoints)
  {
  ...
  AfterThreadedGenerateData()
{
  ...
  if (featurePoints)
  {
    ...
    DisplacementsPointer const displacements = this->GetDisplacements();
    ...
    DisplacementsPointsContainerPointerType const displacementsPoints = DisplacementsPointsContainerType::New();
    ...
    DisplacementsPointDataContainerPointerType const displacementsData = DisplacementsPointDataContainerType::New();

    SimilaritiesPointer const similarities = this->GetSimilarities();
    ...
    SimilaritiesPointsContainerPointerType const similaritiesPoints = SimilaritiesPointsContainerType::New();
    ...
    SimilaritiesPointDataContainerPointerType const similaritiesData = SimilaritiesPointDataContainerType::New();
  ...
  void * arg)
{
  ...
  ThreadIdType const workUnitID = ((MultiThreaderBase::WorkUnitInfo *)(arg))->WorkUnitID;
  ...
  ThreadIdType threadId)
{
  ...
  MovingImageConstPointer const   movingImage = this->GetMovingImage();
  FeaturePointsConstPointer const featurePoints = this->GetFeaturePoints();

  SizeValueType const workUnitCount = this->GetNumberOfWorkUnits();

  // compute first point and number of points (count) for this thread
  SizeValueType       count = m_PointsCount / workUnitCount;
  SizeValueType const first = threadId * count;
  ...
  {
    FeaturePointsPhysicalCoordinates const originalLocation = featurePoints->GetPoint(idx);
    ...
    ImageIndexType const start = fixedIndex - this->m_SearchRadius;
