...
SyNImageRegistrationMethod<TFixedImage, TMovingImage, TOutputTransform, TVirtualImage, TPointSet>::StartOptimization()
{
  ...
  while (this->m_CurrentIteration++ < this->m_NumberOfIterationsPerLevel[this->m_CurrentLevel] && !this->m_IsConverged)
  {
    ...
    DisplacementFieldPointer const fixedToMiddleSmoothUpdateField = this->ComputeUpdateField(this->m_FixedSmoothImages,
    ...
    DisplacementFieldPointer const movingToMiddleSmoothUpdateField =
    ...
    DisplacementFieldPointer const fixedToMiddleSmoothTotalFieldTmp = this->GaussianSmoothDisplacementField(
    ...
    DisplacementFieldPointer const movingToMiddleSmoothTotalFieldTmp = this->GaussianSmoothDisplacementField(
      movingComposer->GetOutput(), this->m_GaussianSmoothingVarianceForTheTotalField);

    // Iteratively estimate the inverse fields.

    DisplacementFieldPointer const fixedToMiddleSmoothTotalFieldInverse = this->InvertDisplacementField(
      fixedToMiddleSmoothTotalFieldTmp, this->m_FixedToMiddleTransform->GetInverseDisplacementField());
    DisplacementFieldPointer const fixedToMiddleSmoothTotalField =
      this->InvertDisplacementField(fixedToMiddleSmoothTotalFieldInverse, fixedToMiddleSmoothTotalFieldTmp);

    DisplacementFieldPointer const movingToMiddleSmoothTotalFieldInverse = this->InvertDisplacementField(
      movingToMiddleSmoothTotalFieldTmp, this->m_MovingToMiddleTransform->GetInverseDisplacementField());
    DisplacementFieldPointer const movingToMiddleSmoothTotalField =
...
typename SyNImageRegistrationMethod<TFixedImage, TMovingImage, TOutputTransform, TVirtualImage, TPointSet>::
  ...
  SyNImageRegistrationMethod<TFixedImage, TMovingImage, TOutputTransform, TVirtualImage, TPointSet>::ComputeUpdateField(
    ...
    MeasureType &                       value)
{
  DisplacementFieldPointer const metricGradientField = this->ComputeMetricGradientField(fixedImages,
                                                                                        fixedPointSets,
                                                                                        fixedTransform,
                                                                                        movingImages,
                                                                                        movingPointSets,
  ...
  DisplacementFieldPointer const updateField =
                               ...
                               MeasureType &                       value)
{
      ...
      this->m_Metric->GetMetricCategory() != ObjectToObjectMetricBaseTemplateEnums::MetricCategory::POINT_SET_METRIC)
  {
    ...
    DisplacementFieldTransformPointer const identityDisplacementFieldTransform = DisplacementFieldTransformType::New();
    ...
    GaussianSmoothDisplacementField(const DisplacementFieldType * field, const RealType variance)
{
  ...
  RealType const weight2 = 1.0 - weight1;
