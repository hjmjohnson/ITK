...
ImageRegistration(int argc, char * argv[])
{
  ...
  typename Optimizerv4Type::ScalesType::Superclass const scales(scaleData, 3);
  ...
  typename TransformType::ParametersType const results = registration->GetTransform()->GetParameters();
