...
PerformTimeVaryingBSplineVelocityFieldImageRegistration(int argc, char * argv[])
{
  ...
  typename TimeVaryingVelocityFieldControlPointLatticeType::Pointer const velocityFieldLattice =
  ...
  typename VelocityFieldTransformAdaptorType::Pointer const initialFieldTransformAdaptor =
  ...
  std::string const warpedMovingImageFileName =
  ...
  std::string const velocityFieldLatticeFileName =
