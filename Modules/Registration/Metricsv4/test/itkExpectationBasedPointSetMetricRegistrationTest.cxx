...
itkExpectationBasedPointSetMetricRegistrationTest(int argc, char * argv[])
{
  ...
  */
  ...
  bool                                                   passed = true;
  PointType::ValueType const                             tolerance = 1e-4;
  AffineTransformType::InverseTransformBasePointer const movingInverse =
    metric->GetMovingTransform()->GetInverseTransform();
  AffineTransformType::InverseTransformBasePointer const fixedInverse =
