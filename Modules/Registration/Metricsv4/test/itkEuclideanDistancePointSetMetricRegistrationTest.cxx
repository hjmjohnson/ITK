                                                      ...
                                                      typename TMetric::Pointer &    metric)
{
  ...
  float const theta = itk::Math::pi / static_cast<float>(180.0) * static_cast<float>(1.0);
  ...
  if (transform->GetTransformCategory() == TTransform::TransformCategoryEnum::DisplacementField)
  {
    ...
    {
      typename TTransform::ParametersValueType const zero{};
  ...
  typename TTransform::InverseTransformBasePointer const fixedInverse =
...
itkEuclideanDistancePointSetMetricRegistrationTest(int argc, char * argv[])
{
  ...
  DisplacementFieldTransformType::OutputVectorType const zeroVector{};
