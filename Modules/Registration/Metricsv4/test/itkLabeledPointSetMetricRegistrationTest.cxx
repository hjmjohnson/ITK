...
itkLabeledPointSetMetricRegistrationTestPerMetric(unsigned int numberOfIterations, PointSetMetricType * pointSetMetric)
{
  ...
  bool                                                            passed = true;
  typename PointType::ValueType const                             tolerance = 1e-2;
  typename AffineTransformType::InverseTransformBasePointer const movingInverse =
    metric->GetMovingTransform()->GetInverseTransform();
  typename AffineTransformType::InverseTransformBasePointer const fixedInverse =
