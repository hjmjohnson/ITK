...
itkMultiStartImageToImageMetricv4RegistrationTest(int argc, char * argv[])
{
  ...
  fixedcaster->Update();
  InternalImageType::Pointer const fixedImage = fixedcaster->GetOutput();

  // get the images
  auto movingcaster = CastFilterType::New();
  movingcaster->SetInput(movingImageReader->GetOutput());
  movingcaster->Update();
  InternalImageType::Pointer const movingImage = movingcaster->GetOutput();
