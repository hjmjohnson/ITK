...
{
  typename VirtualImageType::ConstPointer const virtualImage = this->m_Associate->GetVirtualImage();
...
{
  typename TImageToImageMetricv4::VirtualPointSetType::ConstPointer const virtualSampledPointSet =
