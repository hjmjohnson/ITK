...
itkDOMTest1(int, char *[])
{
  ...
  {
    // create a DOM object
    itk::DOMNode::Pointer const dom = itk::DOMNode::New();
    ...
    // add some children
    // 1st child
    itk::DOMNode::Pointer const child1 = itk::DOMNode::New();
    child1->SetName("city");
    child1->SetAttribute("name", "New York");
    dom->AddChild(child1);
    // 2nd child
    itk::DOMNode::Pointer const child2 = itk::DOMNode::New();
    child2->SetName("city");
    child2->SetAttribute("id", "dc");
    child2->SetAttribute("name", "District of Columbia");
    dom->AddChild(child2);
    // 3rd child
    itk::DOMNode::Pointer const child3 = itk::DOMNode::New();
