...
itkDOMTest5(int argc, char * argv[])
{
  ...
  try
  {
    ...
    itk::DOMTestObject::Pointer const testobj1 = itk::DOMTestObject::New();
    // settings for foo
    ...
    itk::DOMTestObjectDOMWriter::Pointer const writer = itk::DOMTestObjectDOMWriter::New();
    ...
    itk::DOMTestObjectDOMReader::Pointer const reader = itk::DOMTestObjectDOMReader::New();
