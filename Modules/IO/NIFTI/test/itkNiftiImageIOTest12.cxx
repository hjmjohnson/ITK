...
itkNiftiImageIOTest12(int argc, char * argv[])
{
  ...
  ImageType::SizeType const size = { { 24, 10, 11 } };
  region.SetSize(size);
...
#else
  ImageType::IndexType const startIndex = { { 0, 0, 0 } };
#endif
  ...
  try
  {
    ...
    ImageType::Pointer const readImage = itk::IOTestHelper::ReadImage<ImageType>(imgfilename);
    ...
    ImageType::IndexType const threeIndex = { { 3, 3, 3 } };
