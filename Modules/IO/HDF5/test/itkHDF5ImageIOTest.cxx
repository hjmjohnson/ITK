...
HDF5ReadWriteTest(const char * fileName)
{
  ...
  typename ImageType::Pointer const im =
...
{
  int const success(EXIT_SUCCESS);

  itk::HDF5ImageIO::Pointer const io = itk::HDF5ImageIO::New();
...
itkHDF5ImageIOTest(int argc, char * argv[])
{
  ...
  itk::HDF5ImageIO::Pointer const imageio = itk::HDF5ImageIO::New();
