...
JPEGImageIO::CanReadFile(const char * file)
{
  ...
  bool const extensionFound = this->HasSupportedReadExtension(file, false);
  ...
  JPEGFileWrapper const JPEGfp(file, "rb");
...
JPEGImageIO::Read(void * buffer)
{
  ...
  JPEGFileWrapper const JPEGfp(this->GetFileName(), "rb");
...
JPEGImageIO::ReadImageInformation()
{
  ...
  // use this class so return will call close
  JPEGFileWrapper const JPEGfp(m_FileName.c_str(), "rb");
  FILE *                fp = JPEGfp.m_FilePointer;
  if (!fp)
  {
    itkExceptionMacro("Error JPEGImageIO could not open file: " << this->GetFileName() << std::endl
...
{
  // use this class so return will call close
  JPEGFileWrapper const JPEGfp(fileName.c_str(), "wb");
  FILE *                fp = JPEGfp.m_FilePointer;
  if (!fp)
  {
