...
itkPNGImageIOTest(int argc, char * argv[])
{
  ...
  // Read in the image
  itk::PNGImageIO::Pointer const io = itk::PNGImageIO::New();
  ...
  int const compressionLevel = std::stoi(argv[4]);
  ...
  itk::ImageFileReader<RGBImageType>::Pointer const reader = itk::ImageFileReader<RGBImageType>::New();
  ...
  // Try writing
  itk::ImageFileWriter<RGBImageType>::Pointer const writer = itk::ImageFileWriter<RGBImageType>::New();
  ...
  ImageType3D::IndexType const start3D{};
  ...
  ImageType2D::IndexType const start2D{};
  ...
  ImageType1D::IndexType const  start1D{};
  ImageType1D::RegionType const region1D{ start1D, size1D };
