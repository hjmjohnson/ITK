...
GE4ImageIO::ReadHeader(const char * FileNameToRead)
{
  ...
  SizeValueType const file_length = itksys::SystemTools::FileLength(FileNameToRead);
...
GE4ImageIO::MvtSunf(int numb)
{
  ...
  unsigned int const dg_exp = (numb >> 24) & dexponent;
  unsigned int const dg_sign = numb & signbit;
