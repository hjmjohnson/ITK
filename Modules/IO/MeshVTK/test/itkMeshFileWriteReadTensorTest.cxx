...
itkMeshFileWriteReadTensorTest(int argc, char * argv[])
{
  ...
  Mesh2dType::PixelType const pixel2d{};
  ...
  itk::VTKPolyDataMeshIO::Pointer const vtkPolyDataMeshIO = itk::VTKPolyDataMeshIO::New();
  ...
  Mesh3dType::PixelType const pixel3d{};
  ...
  itk::VTKPolyDataMeshIO::Pointer const vtkPolyDataMeshIO2 = itk::VTKPolyDataMeshIO::New();
