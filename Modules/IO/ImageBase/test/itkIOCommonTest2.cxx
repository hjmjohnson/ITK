...
itkIOCommonTest2(int, char *[])
{
  ...
  {
    std::string const unsignedCharPixelType =
    ...
    std::string const charPixelType = itk::IOCommon::AtomicPixelTypeToString(itk::IOCommon::AtomicPixelEnum::ITK_CHAR);
    ...
    std::string const unsignedShortPixelType =
    ...
    std::string const shortPixelType =
    ...
    std::string const unsignedIntPixelType =
    ...
    std::string const intPixelType = itk::IOCommon::AtomicPixelTypeToString(itk::IOCommon::AtomicPixelEnum::ITK_INT);
    ...
    std::string const unsignedLongPixelType =
    ...
    std::string const longPixelType = itk::IOCommon::AtomicPixelTypeToString(itk::IOCommon::AtomicPixelEnum::ITK_LONG);
    ...
    std::string const floatPixelType =
    ...
    std::string const doublePixelType =
  ...
  {
    unsigned int const unsignedCharPixelTypeSize =
    ...
    unsigned int const charPixelTypeSize =
    ...
    unsigned int const unsignedShortPixelTypeSize =
    ...
    unsigned int const shortPixelTypeSize =
    ...
    unsigned int const unsignedIntPixelTypeSize =
    ...
    unsigned int const intPixelTypeSize =
    ...
    unsigned int const unsignedLongPixelTypeSize =
    ...
    unsigned int const longPixelTypeSize =
    ...
    unsigned int const floatPixelTypeSize =
    ...
    unsigned int const doublePixelTypeSize =
