...
itkImageFileReaderDimensionsTest(int argc, char * argv[])
{
  ...
  try
  {
    ...
    Image4DType::RegionType const region = reader->GetOutput()->GetLargestPossibleRegion();
