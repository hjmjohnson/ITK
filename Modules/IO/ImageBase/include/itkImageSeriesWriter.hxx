...
ImageSeriesWriter<TInputImage, TOutputImage>::GenerateNumericFileNames()
{
  ...
  ImageRegion<TInputImage::ImageDimension> const inRegion = inputImage->GetRequestedRegion();
...
ImageSeriesWriter<TInputImage, TOutputImage>::WriteFiles()
{
  ...
  SizeValueType const pixelsPerFile = outputImage->GetRequestedRegion().GetNumberOfPixels();
