  ...
  size_t                 size)
{
  ...
  while (inputData != endInput)
  {
    ...
    //
    double const tempval = ((2125.0 * static_cast<double>(*inputData) + 7154.0 * static_cast<double>(*(inputData + 1)) +
...
ConvertPixelBuffer<InputPixelType, OutputPixelType, OutputConvertTraits>::ConvertVectorToVector(
  ...
  size_t                 size)
{
  int const outputNumberOfComponents = OutputConvertTraits::GetNumberOfComponents();
  int const componentCount = std::min(inputNumberOfComponents, outputNumberOfComponents);
...
ConvertPixelBuffer<InputPixelType, OutputPixelType, OutputConvertTraits>::ConvertVectorImage(
  ...
  size_t                 size)
{
  size_t const length = size * static_cast<size_t>(inputNumberOfComponents);
