...
TestBaseClassMethodsMeshIO(typename TMeshIO::Pointer meshIO)
{
  ...
  FloatType const floatValue = 1.0;
  ...
  RGBPixelType const rgbValue{ 1.0 };
  usePointPixel = true;
  ...
  ComplexPixelType const complexPixelValue(1.0, 1.0);
  usePointPixel = true;
  ...
  ArrayPixelType const arrayPixelValue{};
  usePointPixel = true;
  ...
  VariableLengthVectorPixelType const variableLengthVectorValue{};
  usePointPixel = true;
  ...
  VariableSizeMatrixType const matrix{};
  usePointPixel = true;
  ...
  itk::IOComponentEnum const floatComponent = itk::IOComponentEnum::FLOAT;
  ...
  itk::CommonEnums::IOPixel const pixelType = itk::CommonEnums::IOPixel::SCALAR;
  std::cout << "PixelTypeAsString: " << meshIO->GetPixelTypeAsString(pixelType) << std::endl;

  itk::CommonEnums::IOComponent const pointComponentType = itk::CommonEnums::IOComponent::FLOAT;
  ...
  itk::MeshIOBase::SizeValueType const numberOfCellPixels = 600;
  ...
  itk::IOByteOrderEnum const ioByteOrder = itk::IOByteOrderEnum::BigEndian;
  ...
  itk::MeshIOBase::ArrayOfExtensionsType const supportedReadExtensions = meshIO->GetSupportedReadExtensions();
  ...
  itk::MeshIOBase::ArrayOfExtensionsType const supportedWriteExtensions = meshIO->GetSupportedWriteExtensions();
