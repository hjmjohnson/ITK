#ifndef itkMeshFileReaderExplicit_h
#define itkMeshFileReaderExplicit_h

#include "ITKIOMeshBaseExport.h"

extern template class ITKIOMeshBase_EXPORT itk::MeshFileReader<itk::Mesh<itk::VariableLengthVector<float>, 3u, itk::DefaultStaticMeshTraits<itk::VariableLengthVector<float>, 3u, 3u, float, float, itk::VariableLengthVector<float> > >, itk::MeshConvertPixelTraits<itk::VariableLengthVector<float> >, itk::MeshConvertPixelTraits<itk::VariableLengthVector<float> > >; //Instantiated 3 times
extern template class ITKIOMeshBase_EXPORT itk::MeshFileReader<itk::Mesh<float, 3u, itk::DefaultStaticMeshTraits<float, 3u, 3u, float, float, float> >, itk::MeshConvertPixelTraits<float>, itk::MeshConvertPixelTraits<float> >; //Instantiated 9 times
...
#endif //itkMeshFileReaderExplicit_h
