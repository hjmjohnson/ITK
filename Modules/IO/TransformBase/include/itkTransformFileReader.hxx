...
template<typename ScalarType, typename TFixedParametersValueType>
TransformFileReaderTemplate<ScalarType, TFixedParametersValueType>
...
template<typename ScalarType, typename TFixedParametersValueType>
void TransformFileReaderTemplate<ScalarType, TFixedParametersValueType>
::Update()
{
  if ( m_FileName == "" )
    {
  ...
  if( m_TransformIO.IsNull() )
    {
    typedef TransformIOFactoryTemplate< ScalarType,TFixedParametersValueType > TransformFactoryIOType;
    m_TransformIO = TransformFactoryIOType::CreateTransformIO( m_FileName.c_str(), /*TransformIOFactoryTemplate<ScalarType, TFixedParametersValueType>::*/ ReadMode );
    if ( m_TransformIO.IsNull() )
      {
  ...
  if(firstTransformName.find("CompositeTransform") != std::string::npos)
    ...
    CompositeTransformIOHelperTemplate<ScalarType,TFixedParametersValueType> helper;
