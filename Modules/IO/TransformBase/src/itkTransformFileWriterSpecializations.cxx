...
struct TransformIOHelper
{
  ...
  CreateNewTypeTransform(std::string transformName)
  {
    ...
    TransformIOBaseTemplate<OutputParameterValueType,OutputFixedParameterValueType>::CorrectTransformPrecisionType( transformName );
...
inline void AddToTransformList(typename TInputTransformType::ConstPointer &transform,
  ...
  typedef TransformBaseTemplate<InputParameterValueType,InputFixedParameterValueType>   InputTransformType;
  ...
  typedef TransformBaseTemplate<OutputParameterValueType,OutputFixedParameterValueType> OutputTransformType;
  ...
  if( transformName.find("CompositeTransform") == std::string::npos )
    ...
    */
    CompositeTransformIOHelperTemplate<InputParameterValueType,InputFixedParameterValueType> inputHelper;
    ...
    */
    ...
    CompositeTransformIOHelperTemplate<OutputParameterValueType,OutputFixedParameterValueType> outputHelper;
...
void AddToTransformList<TransformBaseTemplate<double,double>,TransformBaseTemplate<double,double> >(
                      TransformBaseTemplate<double,double>::ConstPointer &transform,
                      std::list< TransformBaseTemplate<double,double>::ConstPointer > & transformList)
{
  transformList.push_back( transform );
}

template<> //If types match, no conversion
void AddToTransformList<TransformBaseTemplate<float,float>, TransformBaseTemplate<float,float> >(
                      TransformBaseTemplate<float,float>::ConstPointer &transform,
                      std::list< TransformBaseTemplate<float,float>::ConstPointer > & transformList)
{
  transformList.push_back( transform );
}

template<> //If types match, no conversion
void AddToTransformList<TransformBaseTemplate<float,double>,TransformBaseTemplate<float,double> >(
                      TransformBaseTemplate<float,double>::ConstPointer &transform,
                      std::list< TransformBaseTemplate<float,double>::ConstPointer > & transformList)
{
  transformList.push_back( transform );
}
...
template<>
void TransformFileWriterTemplate<double,double>
::PushBackTransformList(const Object *transObj)
{
  TransformBaseTemplate<double,double>::ConstPointer dblptr = dynamic_cast<const TransformBaseTemplate<double,double> *>( transObj );
  if( dblptr.IsNotNull() )
    {
    AddToTransformList<TransformBaseTemplate<double,double>,
      TransformBaseTemplate<ParameterValueType,FixedParameterValueType> >( dblptr, m_TransformList );
    }
  else
    {
    TransformBaseTemplate<float,float>::ConstPointer fltptr = dynamic_cast<const TransformBaseTemplate<float,float> *>( transObj );
    if( fltptr.IsNotNull() )
      {
      AddToTransformList<TransformBaseTemplate<float,float>,
        TransformBaseTemplate<ParameterValueType,FixedParameterValueType> >( fltptr, m_TransformList );
      }
    else
      {
      TransformBaseTemplate<float,double>::ConstPointer fltDblptr = dynamic_cast<const TransformBaseTemplate<float,double> *>( transObj );
      if( fltDblptr.IsNotNull() )
        {
        AddToTransformList<TransformBaseTemplate<float,double>,
          TransformBaseTemplate<ParameterValueType,FixedParameterValueType> >( fltDblptr, m_TransformList );
        }
      else
        {
...
template<>
void TransformFileWriterTemplate<float,float>
::PushBackTransformList(const Object *transObj)
{
  TransformBaseTemplate<double,double>::ConstPointer dblptr = dynamic_cast<const TransformBaseTemplate<double,double> *>( transObj );
  if( dblptr.IsNotNull() )
...
template<>
void TransformFileWriterTemplate<float,double>
::PushBackTransformList(const Object *transObj)
{
  TransformBaseTemplate<double,double>::ConstPointer dblptr = dynamic_cast<const TransformBaseTemplate<double,double> *>( transObj );
  if( dblptr.IsNotNull() )
