...
TransformFileReaderTemplate<TParametersValueType>::Update()
{
  ...
  std::string const transformTypeName = ioTransformList.front()->GetNameOfClass();
  ...
  {
    typename TransformListType::const_iterator const tit = ioTransformList.begin();
    typename TransformType::Pointer const            composite = tit->GetPointer();
