...
itkMINCImageIOTest2(int argc, char * argv[])
{
  ...
  itk::MINCImageIO::Pointer const mincIO1 = itk::MINCImageIO::New();

  ITK_EXERCISE_BASIC_OBJECT_METHODS(mincIO1, MINCImageIO, ImageIOBase);


  unsigned int const         supportedDimCount = 4; // includes the degenerate 0-dimensional case
  ...
  itk::MINCImageIO::Pointer const mincIO2 = itk::MINCImageIO::New();
