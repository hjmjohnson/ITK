...
ReadWriteTest(const std::string fileName, const bool isRealDisplacementField, const bool useCompression)
{
  ...
  auto knownField = FieldType::New(); // This is based on itk::Image
  {
    ...
    typename FieldType::IndexType const  start{};
    typename FieldType::RegionType const region{ start, size };
  ...
  if (isRealDisplacementField)
  {
    ...
    typename DisplacementTransformType::ConstPointer const readDisplacementTransform =
    ...
    typename DisplacementTransformType::DisplacementFieldType::ConstPointer const readDisplacement =
...
oneTest(const std::string goodname, const std::string badname, const bool useCompression)
{
  ...
  typename itk::TransformFileWriterTemplate<TParametersValueType>::Pointer const writer =
    itk::TransformFileWriterTemplate<TParametersValueType>::New();
  writer->SetUseCompression(useCompression);
  typename itk::TransformFileReaderTemplate<TParametersValueType>::Pointer const reader =
  ...
  typename itk::TransformFileWriterTemplate<TParametersValueType>::Pointer const badwriter =
    itk::TransformFileWriterTemplate<TParametersValueType>::New();
  badwriter->SetUseCompression(useCompression);
  typename itk::TransformFileReaderTemplate<TParametersValueType>::Pointer const badreader =
    itk::TransformFileReaderTemplate<TParametersValueType>::New();
