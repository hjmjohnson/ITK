...
buildPolygonGroup(PolygonGroup3DPointer & PolygonGroup)
{
  try
  {
    ...
    {
      itk::PolygonSpatialObject<3>::Pointer const strand = itk::PolygonSpatialObject<3>::New();
...
testPolygonGroupEquivalence(PolygonGroup3DPointer & p1, PolygonGroup3DPointer & p2)
{
  ...
  while (it1 != end1)
  {
    ...
    while (pointIt1 != pointItEnd1)
    {
      ...
      Polygon3DType::PointType const curpoint1 = pointIt1->GetPositionInWorldSpace();
      Polygon3DType::PointType const curpoint2 = pointIt2->GetPositionInWorldSpace();
...
itkPolygonGroupSpatialObjectXMLFileTest(int argc, char * argv[])
{
  ...
  try
  {
    itk::PolygonGroupSpatialObjectXMLFileWriter::Pointer const pw = itk::PolygonGroupSpatialObjectXMLFileWriter::New();
  ...
  try
  {
    itk::PolygonGroupSpatialObjectXMLFileReader::Pointer const p = itk::PolygonGroupSpatialObjectXMLFileReader::New();
