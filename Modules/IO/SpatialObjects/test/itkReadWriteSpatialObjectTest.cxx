...
itkReadWriteSpatialObjectTest(int argc, char * argv[])
{
  ...
  GroupPointer const tubeN1 = GroupType::New();
  ...
  ImagePointer const itkImage = itkImageType::New();
  ...
  ImageMaskPointer const itkImageMask = itkImageMaskType::New();
  ...
  ReaderType::SpatialObjectPointer const myScene = reader->GetOutput();
  ...
  for (obj = mySceneChildren->begin(); obj != mySceneChildren->end(); ++obj)
  {
    ...
    {
      maskFound = true;
      itkImageMaskType::ConstPointer const constImage =
