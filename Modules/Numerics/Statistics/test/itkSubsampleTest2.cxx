...
itkSubsampleTest2(int, char *[])
{
  ...
  SampleType::MeasurementVectorSizeType const measurementVectorSize = 3;
  ...
  IteratorType const iter1 = subSample2->Begin();
  IteratorType const iter2 = subSample2->Begin();
  ...
  {
    IteratorType const iter7 = subSample2->Begin();
    ...
    IteratorType const iter4(iter8);
    if (iter4 != iter8)
    {
    ...
    IteratorType const iter5 = iter8;
    if (iter5 != iter8)
    {
      std::cerr << "Iterator operator= failed" << std::endl;
      return EXIT_FAILURE;
    ...
    unsigned int const targetEntry = 2;
  ...
  {
    ConstIteratorType const iter11 = subSample2->Begin();
    ...
    ConstIteratorType const iter3(iter12);
    if (iter3 != iter12)
    {
    ...
    ConstIteratorType const iter5(subSample2->Begin());
    if (iter4 != iter5)
    {
    ...
    ConstIteratorType const iter7(subSample2);
    if (iter6 != iter7)
    {
    ...
    ConstIteratorType const iter8(subSample2);
