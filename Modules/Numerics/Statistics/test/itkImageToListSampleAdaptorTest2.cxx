...
itkImageToListSampleAdaptorTest2(int, char *[])
{
  ...
  ConstIterator const itrBegin = adaptor->Begin();
  ConstIterator const itrEnd = adaptor->End();
  ...
  VariableLengthImageType::RegionType const vRegion(vStart, vSize);
  ...
  unsigned int const rgbMeasurementVectorSize = 3;
  ...
  RGBImageType::RegionType const rgbRegion(rgbStart, rgbSize);
