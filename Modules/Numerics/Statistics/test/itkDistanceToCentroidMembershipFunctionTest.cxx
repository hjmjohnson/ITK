...
itkDistanceToCentroidMembershipFunctionTest(int, char *[])
{
  ...
  try
  {
    MeasurementVectorSizeType const measurementVector2 = MeasurementVectorSize + 1;
  ...
  double const trueValue = 3.31662;
  double const distanceComputed = function->Evaluate(measurement);
  ...
  MembershipFunctionType::Pointer const clonedFunction = function->Clone();
