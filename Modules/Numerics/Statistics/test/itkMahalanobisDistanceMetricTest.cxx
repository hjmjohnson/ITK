...
itkMahalanobisDistanceMetricTest(int, char *[])
{
  ...
  double const epsilon = 1e-200;
  double const doubleMax = 1e+25;
  ...
  DistanceMetricType::MeasurementVectorSizeType const measurementSize2 = 4;
  ...
  DistanceMetricType::MeasurementVectorSizeType const singleComponentMeasurementVectorSize = 1;
