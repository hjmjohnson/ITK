...
itkKdTreeTest3(int argc, char * argv[])
{
  ...
  NumberGeneratorType::Pointer const randomNumberGenerator = NumberGeneratorType::GetInstance();
  ...
  TreeType::Pointer const tree = treeGenerator->GetOutput();
  ...
  MeasurementVectorType const result(measurementVectorSize);
  MeasurementVectorType const test_point(measurementVectorSize);
  MeasurementVectorType const min_point(measurementVectorSize);
