...
itkChiSquareDistributionTest(int, char *[])
{
  ...
  // values of 50:20:150
  double const expected100[] = { 6.953305247616148e-006, 9.845502476408603e-003, 2.468020344001694e-001,
  ...
  for (int i = 0; i <= 5; ++i)
  {
    double const x = static_cast<double>(50 + 20 * i);
