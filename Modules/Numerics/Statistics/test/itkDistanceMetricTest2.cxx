...
itkDistanceMetricTest2(int, char *[])
{
  ...
  MeasurementVectorSizeType const measurementVectorSize = 3;
  ...
  try
  {
    MeasurementVectorSizeType const sameSize = 3;
  ...
  try
  {
    ...
    MeasurementVectorSizeType const newSize = 4;
