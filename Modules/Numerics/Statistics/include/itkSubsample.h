...
public:
  ...
  Begin()
  {
    Iterator const iter(m_IdHolder.begin(), this);
  ...
  End()
  {
    Iterator const iter(m_IdHolder.end(), this);
  ...
  Begin() const
  {
    ConstIterator const iter(m_IdHolder.begin(), this);
  ...
  End() const
  {
    ConstIterator const iter(m_IdHolder.end(), this);
