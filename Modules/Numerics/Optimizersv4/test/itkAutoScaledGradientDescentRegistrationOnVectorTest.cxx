                                                              ...
                                                              std::string scalesOption)
{
  ...
  if (scalesOption.compare("shift") == 0)
  {
    ...
    itk::IndexValueType const centralRegionRadius = 5;
    ...
    typename ShiftScalesEstimatorType::VirtualPointSetType::ConstPointer const virtualDomainPointSet{};
    ...
    typename ShiftScalesEstimatorType::ParametersValueType const smallParameterVariation = 0.01;
  ...
  ParametersType const fixedParameters = movingTransform->GetFixedParameters();
...
itkAutoScaledGradientDescentRegistrationOnVectorTest(int argc, char ** const argv)
{
  ...
  int const ret1 = itkAutoScaledGradientDescentRegistrationOnVectorTestTemplated<TranslationTransformType>(
    numberOfIterations, shiftOfStep, "shift");

  std::cout << std::endl << "Optimizing translation transform with Jacobian scales" << std::endl;
  using TranslationTransformType = itk::TranslationTransform<double, Dimension>;
  int const ret2 = itkAutoScaledGradientDescentRegistrationOnVectorTestTemplated<TranslationTransformType>(
