...
itkRegistrationParameterScalesFromJacobianTest(int, char *[])
{
  ...
  RegistrationParameterScalesFromJacobianType::Pointer const jacobianScaleEstimator =
  ...
  FloatType const stepScale = jacobianScaleEstimator->EstimateStepScale(movingStep);
  ...
  FloatType const localStepScale = jacobianScaleEstimator->EstimateStepScale(displacementStep);
