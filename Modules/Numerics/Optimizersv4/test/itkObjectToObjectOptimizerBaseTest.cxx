...
itkObjectToObjectOptimizerBaseTest(int, char *[])
{
  ...
  ObjectToObjectOptimizerBaseTestOptimizer::NumberOfParametersType const scalesSize =
  ...
  ObjectToObjectOptimizerBaseTestOptimizer::NumberOfParametersType const weightsSize =
    metric->GetNumberOfLocalParameters();
  ITK_TRY_EXPECT_NO_EXCEPTION(optimizer->StartOptimization());
