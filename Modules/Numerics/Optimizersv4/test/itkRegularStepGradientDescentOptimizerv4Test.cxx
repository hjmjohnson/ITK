...
public:
  ...
  GetValueAndDerivative(MeasureType & value, DerivativeType & derivative) const override
  {
    ...
    double const x = m_Parameters[0];
    double const y = m_Parameters[1];
  ...
  typename OptimizerType::MeasureType                  currentLearningRateRelaxation)
{
  ...
  typename OptimizerType::InternalComputationValueType const learningRate = 100;
...
itkRegularStepGradientDescentOptimizerv4Test(int, char *[])
{
  ...
  bool const doEstimateLearningRateAtEachIteration = false;
  bool const doEstimateLearningRateOnce = false;

  itk::SizeValueType const numberOfIterations = 900;

  OptimizerType::InternalComputationValueType const relaxationFactor = 0.5;
  OptimizerType::InternalComputationValueType const minimumStepLength = 1e-6;
  OptimizerType::InternalComputationValueType const gradientMagnitudeTolerance = 1e-6;
  OptimizerType::MeasureType const                  currentLearningRateRelaxation = 0;
  ...
  std::cout << "\nRun test with a different learning rate estimation frequencies:"
            ...
            << std::endl;
  {
    bool const doEstimateLearningRateAtEachIteration2 = true;
    bool const doEstimateLearningRateOnce2 = false;
    testStatus = RegularStepGradientDescentOptimizerv4TestHelper<OptimizerType>(numberOfIterations,
  ...
  std::cout << "\nRun test with a different learning rate estimation frequencies:"
            ...
            << std::endl;
  {
    bool const doEstimateLearningRateAtEachIteration3 = false;
    bool const doEstimateLearningRateOnce3 = true;
  ...
  std::cout << "\nRun test with a different learning rate estimation frequencies:"
            ...
            << std::endl;
  {
    bool const doEstimateLearningRateAtEachIteration4 = true;
    bool const doEstimateLearningRateOnce4 = true;
  ...
  {
    OptimizerType::InternalComputationValueType const relaxationFactor2 = 0.8;
  ...
  {
    itk::SizeValueType const numberOfIterations2 = 0;
  ...
  {
    OptimizerType::InternalComputationValueType const gradientMagnitudeTolerance2 = -1.0;
    bool const                                        expectedExceptionReceived =
  ...
  {
    itk::SizeValueType const                          numberOfIterations3 = 100;
    OptimizerType::InternalComputationValueType const relaxationFactor3 = -1.0;
    OptimizerType::InternalComputationValueType const gradientMagnitudeTolerance3 = 0.01;
    bool const                                        expectedExceptionReceived =
  ...
  {
    itk::SizeValueType const                          numberOfIterations4 = 100;
    OptimizerType::InternalComputationValueType const relaxationFactor4 = 1.1;
    OptimizerType::InternalComputationValueType const gradientMagnitudeTolerance4 = 0.01;
    bool const                                        expectedExceptionReceived =
