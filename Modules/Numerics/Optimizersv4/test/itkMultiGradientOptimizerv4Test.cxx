...
public:
  ...
  GetValue() const override
  {
    double const x = (*m_Parameters)[0];
    double const y = (*m_Parameters)[1];
    double const metric = 0.5 * (3 * x * x + 4 * x * y + 6 * y * y) - 2 * x + 8 * y;
...
public:
  ...
  GetValue() const override
  {
    double const x = (*m_Parameters)[0];
    double const y = (*m_Parameters)[1];
    double const metric = 0.5 * (3 * x * x + 4 * x * y + 6 * y * y) - x + 4 * y;
    std::cout << (*m_Parameters) << " metric " << metric << std::endl;
    return metric;
  }
...
itkMultiGradientOptimizerv4Test(int, char *[])
{
  ...
  OptimizerType::LocalOptimizerPointer const locoptimizer = OptimizerType::LocalOptimizerType::New();
  ...
  OptimizerType::LocalOptimizerPointer const locoptimizer2 = OptimizerType::LocalOptimizerType::New();
