...
public:
  ...
  GetValue() const override
  {
    ...
    MeasureType const value = 0.5 * (3 * x * x + 4 * x * y + 6 * y * y) - 2 * x + 8 * y;
...
itkGradientDescentLineSearchOptimizerv4Test(int, char *[])
{
  ...
  GradientDescentLineSearchOptimizerv4TestMetric::Pointer const metric =
