...
{
  double const mean = 3;                    // Mean of the Cumulative Gaussian.
                                            // Ranges from 0 to N-1, where N is numberOfSamples.
  double const standardDeviation = 2;       // Standard deviation of the Cumulative Gaussian.
  double const lowerAsymptote = -10;        // Lower asymptotic value of the Cumulative Gaussian.
  int const    numberOfSamples = 9;         // Number of data samples.
  double const upperAsymptote = 10;         // Upper asymptotic value of the Cumulative Gaussian.
  double const differenceTolerance = 1e-20; // Tolerance allowed for the difference between Gaussian iterations.
