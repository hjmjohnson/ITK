...
ExhaustiveOptimizer::StartWalking()
{
  ...
  ParametersType const initialPos = this->GetInitialPosition();
  m_MinimumMetricValuePosition = initialPos;
  m_MaximumMetricValuePosition = initialPos;

  MeasureType const initialValue = this->GetValue(this->GetInitialPosition());
...
ExhaustiveOptimizer::ResumeWalking()
{
  ...
  while (!m_Stop)
  {
    ParametersType const currentPosition = this->GetCurrentPosition();
