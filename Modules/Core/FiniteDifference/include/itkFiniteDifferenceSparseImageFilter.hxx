...
FiniteDifferenceSparseImageFilter<TInputImageType, TSparseOutputImageType>::ApplyUpdateThreaderCallback(void * arg)
{
  ...
  ThreadIdType const workUnitCount = ((MultiThreaderBase::WorkUnitInfo *)(arg))->NumberOfWorkUnits;
  ...
  ThreadRegionType   splitRegion;
  ThreadIdType const total = str->Filter->GetSplitRegion(workUnitID, workUnitCount, splitRegion);
  ...
  ThreadIdType) -> TimeStepType
{
  ...
  TimeStepType const timeStep = m_SparseFunction->ComputeGlobalTimeStep(globalData);
