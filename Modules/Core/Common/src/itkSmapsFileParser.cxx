...
struct MapRecordConditionalPlusor
{
  ...
  {
    if (std::search(
          second->m_RecordName.begin(), second->m_RecordName.end(), m_Filter.begin(), m_Filter.end(), ci_equal) !=
        second->m_RecordName.end())
    {
