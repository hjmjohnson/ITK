...
PoolMultiThreader::SetMaximumNumberOfThreads(ThreadIdType numberOfThreads)
{
  ...
  ThreadIdType const threadCount = m_ThreadPool->GetMaximumNumberOfThreads();
                                          ...
                                          ProcessObject *      filter)
{
  ...
  else
  {
    ...
    else
    {
      ...
      ThreadIdType const              splitCount = splitter->GetNumberOfSplits(region, m_NumberOfWorkUnits);
