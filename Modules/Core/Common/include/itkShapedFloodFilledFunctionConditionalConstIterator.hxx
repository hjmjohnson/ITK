...
ShapedFloodFilledFunctionConditionalConstIterator<TImage, TFunction>::InitializeIterator()
{
  ...
  NeighborhoodIteratorType const tmp_iter(radius, this->m_Image, m_ImageRegion);
  ...
  typename TTempImage::RegionType const tempRegion = this->m_Image->GetBufferedRegion();
