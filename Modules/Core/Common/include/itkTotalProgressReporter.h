...
public:
  ...
  Completed(SizeValueType count)
  {
    ...
    {
      SizeValueType const total = static_cast<SizeValueType>(m_PixelsPerUpdate - m_PixelsBeforeUpdate) + count;
      SizeValueType const numberOfUpdates = total / m_PixelsPerUpdate;
