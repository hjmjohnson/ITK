  ...
  TValue *              pointer)
{
  ...
  unsigned int const sizeInVectors = m_ParameterImage->GetPixelContainer()->Size();
  ...
  LightObject *         object)
{
  ...
  else
  {
    ...
    typename CommonContainerType::SizeValueType const sz = image->GetPixelContainer()->Size() * VVectorDimension;
