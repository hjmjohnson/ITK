                                           ...
                                           const DomainThreaderAssociate::TestDomainThreader::DomainType & fullRange)
{
  ...
  DomainThreaderAssociate::TestDomainThreader::Pointer const domainThreader = enclosingClass.GetDomainThreader();
...
itkThreadedIndexedContainerPartitionerTest(int, char *[])
{
  ...
  DomainThreaderAssociate::TestDomainThreader::ConstPointer const domainThreader = enclosingClass.GetDomainThreader();
