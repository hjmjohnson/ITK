...
{
  int const pointDimension = 3;
  int const numOfPoints = 100;
   ...
   */
  PointSet::Pointer const pset(PointSet::New());
  ...
  PointSet::RegionType const region = 0;
  ...
  PointsVectorContainerPointer const pointsArray = PointsVectorContainer::New();
