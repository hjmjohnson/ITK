...
itkImageVectorOptimizerParametersHelperTest(int, char *[])
{
  ...
  ImageVectorPointer const imageOfVectors = ImageVectorType::New();
  ...
  VectorPixelType const vectorvalues(vectorinitvalues);
