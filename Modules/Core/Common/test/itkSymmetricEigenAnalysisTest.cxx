...
itkSymmetricEigenAnalysisTest(int argc, char * argv[])
{
  ...
  if (argc == 2)
  {
    std::string const inputSelectWhatToTest = argv[1];
    std::string const optionEigen = "onlyEigen";
    std::string const optionLegacy = "onlyLegacy";
...

  {
    ...
    InputMatrixType const      S(Sdata, 6, 6);
         ...
         ++useEigenLibrary)
    {
      ...
      double const eigvec3[6] = { 0.5236407, -0.0013422, -0.4199706, -0.5942299, 0.4381326, 0.0659837 };
      double const eigvals[6] = { 0.170864, 2.16934, 3.79272, 15.435, 24.6083, 78.2994 };
...

  {
         ...
         ++useEigenLibrary)
    {
      ...
      double const eigvec3[3] = { 0.0, 1.0, 0.0 };
      double const eigvals[3] = { -1.0, -3.0, 5.0 };
...

  {
    ...
    float const Sdata[9] = { -7.31129000e+00f, 2.33080000e+01f, 0.00000000e+00f, 2.33080000e+01f, -4.64210000e-01f,
         ...
         ++useEigenLibrary)
    {
      ...
      float const eigvec2[3] = { 0.75674412f, -0.6537112f, 0.0f };
      float const eigvals[3] = { -3.26256000e-06f, 1.96703376e+01f, -2.74458376e+01f };
