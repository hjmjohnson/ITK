...
itkLoggerThreadWrapperTest(int argc, char * argv[])
{
  try
  {
    ...
    itk::LoggerThreadWrapper<SimpleLogger>::Pointer const logger = itk::LoggerThreadWrapper<SimpleLogger>::New();
    ...
    itk::MultiThreaderBase::Pointer const threader = itk::MultiThreaderBase::New();
    ...
    //
    itk::StdStreamLogOutput::Pointer const coutput2 = itk::StdStreamLogOutput::New();
    coutput2->SetStream(std::cout);

    itk::LoggerThreadWrapper<SimpleLogger>::Pointer const logger2 = itk::LoggerThreadWrapper<SimpleLogger>::New();
