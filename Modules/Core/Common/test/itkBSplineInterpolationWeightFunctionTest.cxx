...
#  endif
  ...
  { // Creating a local scope
    ...
    SizeType const      size = FunctionType::SupportSize;
    unsigned long const numberOfWeights = FunctionType::NumberOfWeights;
    ...
    ImageType::RegionType const region{ startIndex, size };
