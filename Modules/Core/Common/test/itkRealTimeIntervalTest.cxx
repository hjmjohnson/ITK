...
{
  itk::RealTimeInterval const interval0;

  double const timeInMicroSeconds = interval0.GetTimeInMicroSeconds();
  double const timeInMilliSeconds = interval0.GetTimeInMilliSeconds();
  double       timeInSeconds = interval0.GetTimeInSeconds();
  double const timeInMinutes = interval0.GetTimeInMinutes();
  double const timeInHours = interval0.GetTimeInHours();
  double const timeInDays = interval0.GetTimeInDays();
  ...
  itk::RealTimeInterval const interval1;
