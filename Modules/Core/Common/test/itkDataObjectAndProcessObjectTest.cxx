...
itkDataObjectAndProcessObjectTest(int, char *[])
{
  ...
  itk::MultiThreaderBase::Pointer const multiThreader = process->GetMultiThreader();
  ITK_TEST_SET_GET_VALUE(true, multiThreader.IsNotNull());

  // create some data object that will be used as input and output
  itk::TestDataObject::Pointer const input0 = itk::TestDataObject::New();
  itk::TestDataObject::Pointer const input1 = itk::TestDataObject::New();

  itk::TestDataObject::Pointer const output1 = itk::TestDataObject::New();
  ...
  itk::TestDataObject::Pointer const output = itk::TestDataObject::New();
