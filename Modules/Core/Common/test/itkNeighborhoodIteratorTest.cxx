...
itkNeighborhoodIteratorTest(int, char *[])
{
  ...
  itk::NeighborhoodIterator<TestImageType>::IndexType const zeroIDX{};
  ...
  itk::NeighborhoodIterator<TestImageType>::NeighborhoodType const n = it.GetNeighborhood();
  ...
  itk::NeighborhoodIterator<TestImageType> const it2(it);
  it.Print(std::cout);
  it2.Print(std::cout);
