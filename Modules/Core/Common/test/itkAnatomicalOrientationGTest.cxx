...
TEST(AnatomicalOrientation, ConstructionAndValues)
{
  ...
  AnatomicalOrientation const do2(d);
  ...
  AnatomicalOrientation const do3 = AnatomicalOrientation::CreateFromPositiveStringEncoding("something invalid");
...
TEST(AnatomicalOrientation, ConvertDirectionToPositiveEnum)
{
  ...
  ImageType::DirectionType::InternalMatrixType const m{ data };
  d.GetVnlMatrix() = m;
...
TEST(AntomicalOrientation, ToFromEnumInteroperability)
{
  ...
  itk::AnatomicalOrientation const itk_rai(FromOE::RAI);
...
TEST(AnatomicalOrientation, LegacyInteroperability)
{
  ...
  itk::AnatomicalOrientation const itk_rai(SOE::ITK_COORDINATE_ORIENTATION_RAI);
