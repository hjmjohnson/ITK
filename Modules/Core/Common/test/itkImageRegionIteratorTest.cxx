...
{
  typename itk::Image<T, VImageDimension>::IndexType const regionStartIndex3D = { { 5, 10, 15 } };
  typename itk::Image<T, VImageDimension>::IndexType const regionEndIndex3D = { { 8, 15, 17 } };
...
itkImageRegionIteratorTest(int, char *[])
{
  ...
  itk::Image<itk::Vector<unsigned short, 5>, 3>::Pointer const o3 =
  ...
  itk::Image<itk::Vector<unsigned short, 5>, 3>::SizeType const imageSize3D = { { 20, 40, 60 } };
  itk::Image<itk::Vector<unsigned short, 5>, 3>::SizeType const bufferSize3D = { { 8, 20, 14 } };
  itk::Image<itk::Vector<unsigned short, 5>, 3>::SizeType const regionSize3D = { { 4, 6, 6 } };

  itk::Image<itk::Vector<unsigned short, 5>, 3>::IndexType const startIndex3D = { { 5, 4, 1 } };
  itk::Image<itk::Vector<unsigned short, 5>, 3>::IndexType const bufferStartIndex3D = { { 2, 3, 5 } };
  itk::Image<itk::Vector<unsigned short, 5>, 3>::IndexType const regionStartIndex3D = { { 5, 10, 12 } };
  itk::Image<itk::Vector<unsigned short, 5>, 3>::IndexType const regionEndIndex3D = { { 8, 15, 17 } };
  ...
  for (; !it.IsAtEnd(); ++it)
  {
    itk::Image<itk::Vector<unsigned short, 5>, 3>::IndexType const index = it.GetIndex();
    std::cout << index << std::endl;
  }

  itk::ImageRegionConstIterator<itk::Image<itk::Vector<unsigned short, 5>, 3>> const standardCIt(o3, region);
  ...
  for (; !cit.IsAtEnd(); ++cit)
  {
    itk::Image<itk::Vector<unsigned short, 5>, 3>::IndexType const index = cit.GetIndex();
    std::cout << index << std::endl;
  }
  ...
  // Iterate over a region, then change the region and iterate over the new region
  {
    ...
    TestImageType::IndexType const imageCorner{};

    auto imageSize = TestImageType::SizeType::Filled(3);

    TestImageType::RegionType const imageRegion(imageCorner, imageSize);
    ...
    TestImageType::IndexType const region1Start{};

    auto regionSize = TestImageType::SizeType::Filled(2);

    TestImageType::RegionType const region1(region1Start, regionSize);
    ...
    TestImageType::RegionType const region2(region2start, regionSize);
