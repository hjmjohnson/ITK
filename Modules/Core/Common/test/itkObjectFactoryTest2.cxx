...
itkObjectFactoryTest2(int argc, char * argv[])
{
...
#else
  std::string const pathSeparator = ":";
#endif
  std::string path = "";
  ...
  itk::ImportImageContainer<unsigned long, short>::Pointer const v =
  ...
  itk::RGBPixel<unsigned char> const  rgbUC{};
  itk::RGBPixel<unsigned short> const rgbUS{};
  MakeImage(10, rgbUC);
  MakeImage(10, rgbUS);

  ReallocateImage();

  int const status = EXIT_SUCCESS;
