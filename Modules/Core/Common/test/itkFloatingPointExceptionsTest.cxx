...
itkFloatingPointExceptionsTest(int argc, char * argv[])
{
  ...
  int          error_return(0);
  double const double_zero = itkFloatingPointExceptionsTest_double_zero;
  double const double_max = itkFloatingPointExceptionsTest_double_max;
  double const test1 = itkFloatingPointExceptionsTest_double_zero;
  ...
  if (testName == "DivByZero")
  {
    ...
    try
    {
      double const s = 1.0 / double_zero;
      //
  ...
  if (testName == "ZeroDivByZero")
  {
    ...
    try
    {
      double const s = test1 / double_zero;
      //
      // should never reach here
