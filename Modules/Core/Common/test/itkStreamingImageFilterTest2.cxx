...
itkStreamingImageFilterTest2(int, char *[])
{
  ...
  itk::XMLFileOutputWindow::Pointer const logger = itk::XMLFileOutputWindow::New();
  ...
  // fill in an image
  ShortImage::IndexType const  index = { { 0, 0 } };
  ShortImage::SizeType const   size = { { 42, 64 } };
  ...
  for (; !iterator2.IsAtEnd(); ++iterator2)
  {
    ...
    row += rowOffset;
    short const trueValue = col + region.GetSize()[0] * row;
