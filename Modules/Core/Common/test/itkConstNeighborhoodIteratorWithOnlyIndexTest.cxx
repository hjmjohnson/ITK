...
{
  typename TImage::Pointer const img = itkConstNeighborhoodIteratorWithOnlyIndexTestGetTestImage<TImage>(10, 10, 5, 3);
  ...
  typename ImageType::Pointer const ra_img =
  ...
  typename ImageType::Pointer const iib_img =
