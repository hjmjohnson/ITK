...
itkSTLThreadTest(int argc, char * argv[])
{
  ...
  itk::PlatformMultiThreader::Pointer const threader = itk::PlatformMultiThreader::New();
...
Runner(void * infoIn)
{
  ...
  itk::ThreadIdType const tnum = info->WorkUnitID;
...
Thread(int tnum)
{
  ...
  int const count = 10000 + 100 * tnum;
