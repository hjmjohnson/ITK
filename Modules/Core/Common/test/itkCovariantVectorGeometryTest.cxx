...
itkCovariantVectorGeometryTest(int, char *[])
{
  ...
  ValueType const norm2 = vg.GetSquaredNorm();
  std::cout << "vg squared norm = ";
  std::cout << norm2 << std::endl;

  ValueType const norm = vg.GetNorm();
  std::cout << "vg norm = ";
  std::cout << norm << std::endl;

  ValueType const normX = vg.Normalize();
