...
itkTorusInteriorExteriorSpatialFunctionTest(int, char *[])
{
  ...
  TorusInteriorExteriorSpatialFunctionType::Pointer const torusInteriorExteriorSpatialFunction =
  ...
  TorusInteriorExteriorSpatialFunctionType::OutputType const insidePointOutputValue =
    torusInteriorExteriorSpatialFunction->Evaluate(insidePoint);

  TorusInteriorExteriorSpatialFunctionType::OutputType const outsidePointOutputValue =
