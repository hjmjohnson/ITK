...
itkImageIteratorTest(int, char *[])
{
  ...
  itk::Image<itk::Vector<unsigned short, 5>, ImageDimension>::Pointer const o3 =
  ...
  itk::Image<itk::Vector<unsigned short, 5>, ImageDimension>::SizeType const imageSize3D = { { 20, 40, 60 } };

  itk::Image<itk::Vector<unsigned short, 5>, ImageDimension>::IndexType const startIndex3D = { { 5, 4, 1 } };
  itk::Image<itk::Vector<unsigned short, 5>, ImageDimension>::IndexType const regionStartIndex3D = { { 5, 10, 12 } };
  itk::Image<itk::Vector<unsigned short, 5>, ImageDimension>::IndexType const regionEndIndex3D = { { 8, 15, 17 } };


  itk::Image<itk::Vector<unsigned short, 5>, ImageDimension>::RegionType const region{ startIndex3D, imageSize3D };
  ...
  VectorImageConstIterator const itr2(o3, region);

  // Exercise copy constructor
  VectorImageIterator const itr3(itr1);
  ...
  // Exercise GetIndex()
  VectorImageType::IndexType const index1 = itr1.GetIndex();
  ...
  // Exercise GetRegion()
  VectorImageType::RegionType const region1 = itr1.GetRegion();
  if (region1 != region)
  {
