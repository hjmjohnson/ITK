...
itkImportImageTest(int, char *[])
{
  ...
  itk::ImageRegion<Dimension>::IndexType const index = { { 0, 0 } };
  itk::ImageRegion<Dimension>::SizeType const  size = { { 8, 12 } };
  ...
  itk::ShrinkImageFilter<ImportImageFilter::OutputImageType, ShortImage>::Pointer const shrink =
