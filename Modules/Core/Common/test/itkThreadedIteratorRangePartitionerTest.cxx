...
public:
  ...
  private:
    ...
    BeforeThreadedExecution() override
    {
      ...
      BorderValuesType const unsetBorderValues(2, -1);
  ...
  const IteratorRangeDomainThreaderAssociate::TestDomainThreader::DomainType & fullDomain)
{
  ...
  IteratorRangeDomainThreaderAssociate::TestDomainThreader::Pointer const domainThreader =
            ...
            IteratorRangeDomainThreaderAssociate::TestDomainThreader::DomainType & fullDomain)
{
  ...
  IteratorRangeDomainThreaderAssociate::TestDomainThreader::DomainType const newDomain(beginIt, endIt);
...
{
  IteratorRangeDomainThreaderAssociate                                         enclosingClass;
  IteratorRangeDomainThreaderAssociate::TestDomainThreader::ConstPointer const domainThreader =
    enclosingClass.GetDomainThreader();
  ...
  if (domainThreader->GetMultiThreader()->GetGlobalMaximumNumberOfThreads() > 1)
  {
    ...
    itk::ThreadIdType const maxNumberOfThreads = domainThreader->GetMultiThreader()->GetGlobalMaximumNumberOfThreads();
