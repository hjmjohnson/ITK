...
itkImageTest(int, char *[])
{
  ...
  Image::ConstPointer const myconstptr = image;
  image->DebugOn();
  ...
  Image::PointType const originRef{};
  ...
  Image::RegionType const boxRegion = itk::ImageAlgorithm::EnlargeRegionOverBox(image->GetLargestPossibleRegion(),
                                                                                image.GetPointer(),
                                                                                imageRef.GetPointer(),
                                                                                static_cast<TransformType *>(nullptr));
  Image::IndexType const  correctIndex{};
  ...
  Image3D::PointType const originVol{};
  ...
  Image3D::IndexType const indexCuboid{};
  ...
  Image::RegionType const rectangleRegion = itk::ImageAlgorithm::EnlargeRegionOverBox(
    volume->GetLargestPossibleRegion(), volume.GetPointer(), imageRef.GetPointer(), projectionTransform);

  delete projectionTransform;
  Image::IndexType const correctRectangleIndex{};
  ...
  Image::RegionType const tesBoxRegion = itk::ImageAlgorithm::EnlargeRegionOverBox(
