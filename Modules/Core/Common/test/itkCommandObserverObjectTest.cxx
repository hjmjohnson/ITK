...
{
  unsigned long const idToRemove = *static_cast<unsigned long *>(data);
...
{
  itk::Object::Pointer const o = itk::Object::New();


  unsigned long idToRemove;

  itk::CStyleCommand::Pointer const removeCmd = itk::CStyleCommand::New();
  removeCmd->SetCallback(onUserRemove);
  removeCmd->SetObjectName("Remove Command");

  itk::CStyleCommand::Pointer const cmd = itk::CStyleCommand::New();
...
testCommandConstObject()
{
  ...
  itk::Object::Pointer const      o = itk::Object::New();
  itk::Object::ConstPointer const co = o;
...
testCommandRecursiveObject()
{
  ...
  itk::CStyleCommand::Pointer const cmdInvoke = itk::CStyleCommand::New();
