...
public:
  ...
  private:
    ...
    AfterThreadedExecution() override
    {
      ...
      {
        double const sum = this->m_PerThreadCompensatedSum[i].GetSum();
...
itkCompensatedSummationTest2(int, char *[])
{
  ...
  CompensatedSummationTest2Associate::TestDomainThreader::Pointer const domainThreader =
  ...
  itk::ThreadIdType const numberOfThreads = 1;
  ...
  double const referenceSum = enclosingClass.GetCompensatedSumOfThreads();
