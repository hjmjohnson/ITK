...
itkImageDuplicatorTest(int, char *[])
{
...

  {
    ...
    RGBImageType::Pointer const RGBImageCopy = RGBduplicator->GetOutput();
    ...
    while (!it4.IsAtEnd())
    {
      ...
      itk::RGBPixel<unsigned char> const pixel = it4.Get();
      if (pixel.GetRed() != r)
      {
...

  {
    ...
    VectorImageType::Pointer const vectorImageCopy = Vectorduplicator->GetOutput();
    ...
    while (!it4.IsAtEnd())
    {
      itk::VariableLengthVector<PixelType> const pixel4 = it4.Get();
      itk::VariableLengthVector<PixelType> const pixel3 = it3.Get();
      if (pixel4 != pixel3)
      {
        return EXIT_FAILURE;
      }
