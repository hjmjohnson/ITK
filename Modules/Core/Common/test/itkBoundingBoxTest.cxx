...
itkBoundingBoxTest(int, char *[])
{
  ...
  BB::PointsContainerPointer const Points = BB::PointsContainer::New();
  ...
  BB::PointsContainerConstPointer const NewPoints = myBox->GetPoints();
  ...
  CC::PointsContainerPointer const Points3D = CC::PointsContainer::New();
  ...
  // Testing the DeepCopy method
  {
    ...
    CC::Pointer const           clone = my3DBox->DeepCopy();
