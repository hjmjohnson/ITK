...
TEST(SmartPointer, EmptyAndNull)
{
  ...
  Derived2::Pointer const      p2 = p1;
  Derived2::ConstPointer const cp1 = p1;
  Derived2::ConstPointer const cp2(p1);
  Derived2::ConstPointer const cp3{ p1 };
}
...
TEST(SmartPointer, Converting)
{
  ...
  Derived1Pointer const d1ptr = Derived1::New();
  ...
  ConstDerived1Pointer const cd1ptr(d1ptr);
  EXPECT_TRUE(cd1ptr.GetPointer() == d1ptr.GetPointer());
  EXPECT_TRUE(cd1ptr == d1ptr);

  BasePointer            ptr(d1ptr);
  ConstBasePointer const cptr1(d1ptr);
  ConstBasePointer const cptr2(cd1ptr);
...
TEST(SmartPointer, ConvertingRegisterCount)
{
  ...
  // Move constructor
  {
    ...
    Derived1Pointer const d1ptr2(std::move(d1ptr));
  ...
  // Move constructor to const
  {
    ...
    ConstDerived1Pointer const cd1ptr(std::move(d1ptr));
  ...
  // Move constructor to base
  {
    ...
    BasePointer const bptr(std::move(d1ptr));
