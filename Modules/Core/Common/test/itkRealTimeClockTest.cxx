...
itkRealTimeClockTest(int, char *[])
{
  ...
  try
  {
    ...
    TimeRepresentationType const tolerance = 1e6;

    for (unsigned int i = 0; i < 10; ++i)
    {
      realStamp1 = realStamp2;
      realStamp2 = clock->GetRealTimeStamp();
      itk::RealTimeInterval const                      difference = realStamp2 - realStamp1;
      itk::RealTimeStamp::TimeRepresentationType const seconds1 = realStamp1.GetTimeInSeconds();
      itk::RealTimeStamp::TimeRepresentationType const seconds2 = realStamp2.GetTimeInSeconds();
      itk::RealTimeStamp::TimeRepresentationType const secondsD = difference.GetTimeInSeconds();
      itk::RealTimeStamp::TimeRepresentationType const secondsE = seconds2 - seconds1;
