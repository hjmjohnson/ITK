...
itkPointGeometryTest(int, char *[])
{
  ...
  ValueType const distance = pc.EuclideanDistanceTo(pb);
  std::cout << "Euclidean distance between pc and pb = ";
  std::cout << distance << std::endl;

  ValueType const distance2 = pc.SquaredEuclideanDistanceTo(pb);
  ...
  // Test the Barycentric combination
  {
    ...
    PointType            B = bInit;
    PointType            C = cInit;
    double const         alpha = 1.0 / 3.0;
    double const         beta = 1.0 / 3.0;
