...
itkImageScanlineIteratorTest1(int, char *[])
{
  ...
  ImageType::SizeType const imageSize3D = { { 20, 40, 60 } };
  ImageType::SizeType const bufferSize3D = { { 8, 20, 14 } };
  ImageType::SizeType const regionSize3D = { { 4, 6, 6 } };

  ImageType::IndexType const startIndex3D = { { 5, 4, 1 } };
  ImageType::IndexType const bufferStartIndex3D = { { 2, 3, 5 } };
  ImageType::IndexType const regionStartIndex3D = { { 5, 10, 12 } };
  ImageType::IndexType const regionEndIndex3D = { { 8, 15, 17 } };
  ...
  itk::ImageIterator<ImageType> const standardIt(o3, region);
  ...
  itk::ImageScanlineConstIterator<ImageType> const standardCIt(o3, region);
