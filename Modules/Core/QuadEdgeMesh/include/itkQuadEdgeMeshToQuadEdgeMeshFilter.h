...
CopyMeshToMeshCellData(const TInputMesh * in, TOutputMesh * out)
{
  ...
  InputCellDataContainerConstPointer const inputCellData = in->GetCellData();
  ...
  OutputCellDataContainerPointer const outputCellData = OutputCellDataContainer::New();
  ...
  {
    typename OutputCellDataContainer::Element const point(inIt.Value());
...
CopyMeshToMeshPointData(const TInputMesh * in, TOutputMesh * out)
{
  ...
  OutputPointDataContainerPointer const outputPointData = OutputPointDataContainer::New();
  ...
  {
    typename OutputPointDataContainer::Element const point(inIt.Value());
...
CopyMeshToMeshCells(const TInputMesh * in, TOutputMesh * out)
{
  ...
  InputCellsContainerConstPointer const inCells = in->GetCells();
  ...
  InputCellsContainerConstIterator const cEnd = inCells->End();
  while (cIt != cEnd)
  {
    ...
    if (pe)
    {
      ...
      InputPointsIdInternalIterator const pEnd = pe->InternalPointIdsEnd();
...
CopyMeshToMeshEdgeCells(const TInputMesh * in, TOutputMesh * out)
{
  ...
  InputCellsContainerConstPointer const inEdgeCells = in->GetEdgeCells();
  ...
  InputCellsContainerConstIterator const ecEnd = inEdgeCells->End();
...
CopyMeshToMeshPoints(const TInputMesh * in, TOutputMesh * out)
{
  ...
  InputPointsContainerConstPointer const inPoints = in->GetPoints();
  ...
  InputPointsContainerConstIterator const inEnd = inPoints->End();
