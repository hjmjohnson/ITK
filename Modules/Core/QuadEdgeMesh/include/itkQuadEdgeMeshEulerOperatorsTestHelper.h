...
CreateSquareQuadMesh(typename TMesh::Pointer mesh)
{
  ...
  /////////////////////////////////////////////////////////////
  int const expectedNumPts = 25;
  int const expectedNumCells = 16;
  int const simpleSquareCells[64] = { 0,  1,  6,  5,  1,  2,  7,  6,  2,  3,  8,  7,  3,  4,  9,  8,
...
CreateSquareTriangularMesh(typename TMesh::Pointer mesh)
{
  ...
  /////////////////////////////////////////////////////////////
  int const expectedNumPts = 25;
  int const expectedNumCells = 32;
  int const simpleSquareCells[96] = { 0,  1,  6,  0,  6,  5,  1,  2,  7,  1,  7,  6,  2,  3,  8,  2,  8,  7,  3,  4,
...
CreateTetraedronMesh(typename TMesh::Pointer mesh)
{
  ...
  /////////////////////////////////////////////////////////////
  int const expectedNumPts = 4;
  int const expectedNumCells = 4;
  int const simpleSquareCells[12] = { 0, 1, 2, 1, 0, 3, 1, 3, 2, 2, 3, 0 };
...
CreateSamosa(typename TMesh::Pointer mesh)
{
  ...
  /////////////////////////////////////////////////////////////
  int const expectedNumPts = 3;
  int const expectedNumCells = 2;
  int const simpleSquareCells[6] = { 0, 1, 2, 1, 0, 2 };
