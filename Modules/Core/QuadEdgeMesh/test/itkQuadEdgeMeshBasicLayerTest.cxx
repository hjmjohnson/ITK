...
itkQuadEdgeMeshBasicLayerTest(int, char *[])
{
  ...
  int const org[5] = { 0, 1, 2, 3, 0 };
  int const dest[5] = { 1, 2, 3, 0, 2 };
  ...
  int const onextDestination[5][3] = { { 1, 2, 3 },
  ...
  int const lnextDestination[5][3] = { { 0, 1, 2 }, { 1, 2, 0 }, { 2, 3, 0 }, { 3, 0, 2 }, { 0, 2, 3 } };
  for (int edge = 0; edge < 5; ++edge)
  {
    int test = 0;
  ...
  int const lnextDestinationOnSym[3] = { 2, 0, 1 };
  int       test = 0;
  ...
  int const symDestination[5][3] = { { 0, 1 }, { 1, 2 }, { 2, 3 }, { 3, 0 }, { 0, 2 } };
  for (int edge = 0; edge < 5; ++edge)
  {
    test = 0;
