...
itkQuadEdgeMeshAddFaceTest2(int, char *[])
{
  ...
  int const numPts = 7;
  int const numCells = 4;

  std::cout << "numPts= " << numPts << std::endl;
  std::cout << "numCells= " << numCells << std::endl;

  int const oddConnectivityCells[12] = {
  ...
  int const computedNumPts = mesh->GetNumberOfPoints();
  ...
  int const computedNumFaces = mesh->ComputeNumberOfFaces();
