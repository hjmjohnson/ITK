...
TestCellInterface(std::string name, TCell * aCell)
{
  ...
  CellAutoPointer const cell(aCell, true);
...
TestQECellInterface(std::string name, TCell * aCell)
{
  ...
  typename TCell::PointIdInternalIterator const endId = cell->InternalPointIdsEnd();
  while (pointId != endId)
  {
    std::cout << *pointId << ", ";
    pointId++;
  ...
  typename TCell::PointIdInternalConstIterator const cendId = cell2->InternalPointIdsEnd();
  ...
  typename TCell::PointIdInternalConstIterator const pendId = cell2->InternalPointIdsEnd();
  while (ppointId != pendId)
  {
    std::cout << *ppointId << ", ";
    ppointId++;
  ...
  typename TCell::PointIdInternalIterator const pxendId = cell->InternalPointIdsEnd();
  while (pxpointId != pxendId)
  {
    std::cout << *pxpointId << ", ";
    pxpointId++;
