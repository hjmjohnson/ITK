...
itkQuadEdgeTest1(int, char *[])
{
  ...
  { // create a local scope for these tests
    ...
    QuadEdgeTypePointer const quadEdge1p(quadEdge1, true);
    QuadEdgeTypePointer const quadEdge2p(quadEdge2, true);
    QuadEdgeTypePointer const quadEdge3p(quadEdge3, true);
  ...
  { // create a local scope for these tests
    ...
    QuadEdgeTypePointer const quadEdge2p(quadEdge2, true);
    QuadEdgeTypePointer const quadEdge3p(quadEdge3, true);
    QuadEdgeTypePointer const quadEdge4p(quadEdge4, true);
  ...
  { // create a local scope for these tests
    ...
    QuadEdgeTypePointer const quadEdge3p(quadEdge3, true);
    QuadEdgeTypePointer const quadEdge4p(quadEdge4, true);
    QuadEdgeTypePointer const quadEdgeAp(quadEdgeA, true);
    QuadEdgeTypePointer const quadEdgeBp(quadEdgeB, true);
  ...
  { // create a local scope for these tests
    ...
    QuadEdgeTypePointer const quadEdgeAp(quadEdgeA, true);
    QuadEdgeTypePointer const quadEdgeBp(quadEdgeB, true);
    QuadEdgeTypePointer const quadEdgeCp(quadEdgeC, true);
    QuadEdgeTypePointer const quadEdgeDp(quadEdgeD, true);
  ...
  { // create a local scope for these tests
    ...
    QuadEdgeTypePointer const quadEdge3p(quadEdge3, true);
    QuadEdgeTypePointer const quadEdge4p(quadEdge4, true);
    QuadEdgeTypePointer const quadEdge5p(quadEdge5, true);
    QuadEdgeTypePointer const quadEdge6p(quadEdge6, true);
  ...
  { // create a local scope for these tests
    ...
    QuadEdgeTypePointer const quadEdgeA1p(quadEdgeA1, true);
    QuadEdgeTypePointer const quadEdgeA2p(quadEdgeA2, true);
    QuadEdgeTypePointer const quadEdgeA3p(quadEdgeA3, true);
    QuadEdgeTypePointer const quadEdgeA4p(quadEdgeA4, true);

    QuadEdgeTypePointer const quadEdgeB1p(quadEdgeB1, true);
    QuadEdgeTypePointer const quadEdgeB2p(quadEdgeB2, true);
    QuadEdgeTypePointer const quadEdgeB3p(quadEdgeB3, true);
    QuadEdgeTypePointer const quadEdgeB4p(quadEdgeB4, true);

    QuadEdgeTypePointer const quadEdgeC1p(quadEdgeC1, true);
    QuadEdgeTypePointer const quadEdgeC2p(quadEdgeC2, true);
    QuadEdgeTypePointer const quadEdgeC3p(quadEdgeC3, true);
    QuadEdgeTypePointer const quadEdgeC4p(quadEdgeC4, true);
