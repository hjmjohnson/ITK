...
itkFixedCenterOfRotationAffineTransformTest(int, char *[])
{
  ...
  FAffine2DType::Pointer const      inverse2;
  ...
  typename FCoRAffine2DType::InputVectorType const vScale = itk::MakeVector(2.0, 4.0);
  ...
  FCoRAffine2DType::InputPointType const transformedPoint = aff2->TransformPoint(point);
