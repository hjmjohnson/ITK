...
itkCenteredRigid2DTransformTest(int, char *[])
{
  ...
  CenteredRigidTransformType::OffsetType const      ioffset = ioffsetInit;
...

  {
    ...
    const CenteredRigidTransformType::OutputPointType p2 = transform2->TransformPoint(p1);
    ...
    CenteredRigidTransformType::OutputPointType p3 = inverse->TransformPoint(p2);
    ...
    // Get inverse transform and transform point p2 to obtain point p3
    CenteredRigidTransformType::Pointer const inversebis =
...

  {
    ...
    TransformType::InputPointType const p3 = t2->TransformPoint(p2);
    ...
    TransformType::InputPointType const p4 = t3->TransformPoint(p1);
