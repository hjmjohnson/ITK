...
itkBSplineDeformableTransformTest1()
{
  ...
  DirectionType const direction = transform->GetCoefficientImages()[0]->GetDirection();
   ...
   */
  unsigned long const numberOfParameters = transform->GetNumberOfParameters();
  ...
  unsigned int const            numberOfControlPoints = region.GetNumberOfPixels();
  ...
  unsigned long const n = coeffImage[1]->ComputeOffset(index) + numberOfControlPoints;
  ...
  ParametersType const outParametersCopy = transform->GetParameters();
  ...
  // transformation
  unsigned int const numberOfCoefficientInSupportRegion = TransformType::NumberOfWeights;
  unsigned int const numberOfParametersPerDimension = transform->GetNumberOfParametersPerDimension();
