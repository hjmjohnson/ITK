...
itkSplineKernelTransformTest(int, char *[])
{
  ...
  { // Testing the number of parameters
    EBSTransform2DType::ParametersType const parameters1 = ebs2D->GetParameters();
  ...
  { // Just for code coverage
    TPSTransform2DType::VectorSetType::ConstPointer const tempDisplacements = tps2D->GetDisplacements();
