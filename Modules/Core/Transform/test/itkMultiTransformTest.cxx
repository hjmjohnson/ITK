...
itkMultiTransformTest(int, char *[])
{
  ...
  unsigned int const nParameters = multiTransform->GetNumberOfParameters();
  ...
  unsigned int const affineLocalParamsN = affine->GetNumberOfLocalParameters();
  unsigned int const displacementLocalParamsN = displacementTransform->GetNumberOfLocalParameters();
  unsigned int const nLocalParameters = multiTransform->GetNumberOfLocalParameters();
  ...
  unsigned int const affineFixedParamsN = affine->GetFixedParameters().size();
  unsigned int const displacementFixedParamsN = displacementTransform->GetFixedParameters().size();
  unsigned int const nFixedParameters = multiTransform->GetNumberOfFixedParameters();
  ...
  /* Test accessors */
  Superclass::TransformQueueType const transformQueue = multiTransform->GetTransformQueue();
   ...
   */
  {
    ...
    Superclass::ParametersType const updateResult = multiTransform->GetParameters();
