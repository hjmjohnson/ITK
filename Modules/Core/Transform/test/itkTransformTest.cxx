...
public:
  ...
  RunTests()
  {
    ...
    InputDiffusionTensor3DType const difften;
    vecpix.SetSize(6);
    vecpix.Fill(1.7);
    ...
    InputSymmetricSecondRankTensorType const ssrten;
    ...
    typename TransformType::ParametersType const parameters(6);
    try
    {
