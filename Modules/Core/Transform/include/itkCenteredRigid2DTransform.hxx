...
template <typename TParametersValueType>
void
CenteredRigid2DTransform<TParametersValueType>::ComputeJacobianWithRespectToParameters(const InputPointType & p,
...
template <typename TParametersValueType>
void
CenteredRigid2DTransform<TParametersValueType>::SetFixedParameters(const FixedParametersType & itkNotUsed(parameters))
{
  // no fixed parameters
}
...
template <typename TParametersValueType>
void
CenteredRigid2DTransform<TParametersValueType>::CloneInverseTo(Pointer & result) const
{
  result = New();
...
template <typename TParametersValueType>
bool
CenteredRigid2DTransform<TParametersValueType>::GetInverse(Self * inverse) const
{
  if (!inverse)
  {
    return false;
...
template <typename TParametersValueType>
void
CenteredRigid2DTransform<TParametersValueType>::CloneTo(Pointer & result) const
{
  result = New();
...
template <typename TParametersValueType>
void
CenteredRigid2DTransform<TParametersValueType>::PrintSelf(std::ostream & os, Indent indent) const
{
