...
ComposeScaleSkewVersor3DTransform<TParametersValueType>::ComputeMatrix()
{
  ...
  MatrixType const newMatrix = this->GetMatrix();
  ...
  MatrixType const Q = scaleM * skewM;
  MatrixType const res = newMatrix * Q;
...
ComposeScaleSkewVersor3DTransform<TParametersValueType>::ComputeMatrixParameters()
{
  ...
  double const ortho = M(0, 0) * M(0, 1) + M(1, 0) * M(1, 1) + M(2, 0) * M(2, 1);
  M(0, 1) -= ortho * M(0, 0);
  M(1, 1) -= ortho * M(1, 0);
  M(2, 1) -= ortho * M(2, 0);
  scaleV[0] = M(0, 1);
  ...
  double const ortho0 = M(0, 0) * M(0, 2) + M(1, 0) * M(1, 2) + M(2, 0) * M(2, 2);
  double const ortho1 = M(0, 1) * M(0, 2) + M(1, 1) * M(1, 2) + M(2, 1) * M(2, 2);
  ...
  JacobianType &         jacobian) const
{
  ...
  double const v0v0 = v0 * v0;
  double const v0v1 = v0 * v1;
  double const v0v2 = v0 * v2;
  double const v0w = v0 * w;
  double const v1v1 = v1 * v1;
  double const v1v2 = v1 * v2;
  double const v1w = v1 * w;
  double const v2v2 = v2 * v2;
  double const v2w = v2 * w;
