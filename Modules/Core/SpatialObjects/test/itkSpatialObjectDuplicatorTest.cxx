...
itkSpatialObjectDuplicatorTest(int, char *[])
{
  ...
  EllipseType::Pointer const ellipse_copy = duplicator->GetOutput();
  ...
  GroupType::Pointer const groupCopy = duplicatorGroup->GetOutput();

  GroupType::ChildrenListType * children = groupCopy->GetChildren();

  EllipseType::Pointer const ellipse_copy2 = static_cast<EllipseType *>((*(children->begin())).GetPointer());
  ...
  DTITubeType::Pointer const dtiTube_copy = duplicatorDti->GetOutput();
