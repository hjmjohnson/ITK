...
itkImageMaskSpatialObjectTest2(int, char *[])
{
  ...
  {
    ImageType::IndexType const startPointIndex = { { INSIDE_SIZE - 2, INSIDE_SIZE - 2, INSIDE_SIZE - 2 } };
    ImageType::IndexType const endPointIndex = {
    ...
    for (int i = 0; i < numberOfSteps; ++i)
    {
      ...
      {
        ImageType::IndexType const pointIndex = image->TransformPhysicalPointToIndex(point);
        std::cerr
