...
itkMeshSpatialObjectTest(int, char *[])
{
  ...
  MeshType::CoordRepType const testPointCoords[4][3] = { { 0, 0, 0 }, { 9, 0, 0 }, { 9, 9, 0 }, { 0, 0, 9 } };
  ...
  double const isInsidePrecisionInObjectSpace = 1;
  ...
  MeshType::CoordRepType const testTrianglePointCoords[4][3] = {
