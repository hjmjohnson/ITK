...
MetaGaussianConverter<VDimension>::MetaObjectToSpatialObject(const MetaObjectType * mo) -> SpatialObjectPointer
{
  ...
  GaussianSpatialObjectPointer const gaussianSO = GaussianSpatialObjectType::New();
...
{
  GaussianSpatialObjectConstPointer const gaussianSO = dynamic_cast<const GaussianSpatialObjectType *>(so);
