...
MetaDTITubeConverter<VDimension>::MetaObjectToSpatialObject(const MetaObjectType * mo) -> SpatialObjectPointer
{
  ...
  DTITubeSpatialObjectPointer const tubeSO = DTITubeSpatialObjectType::New();
...
{
  DTITubeSpatialObjectConstPointer const DTITubeSO = dynamic_cast<const DTITubeSpatialObjectType *>(spatialObject);
  if (DTITubeSO.IsNull())
  {
