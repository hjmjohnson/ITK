...
template class itk::RandomImageSource<itk::Image<char, 3u> >; //Instantiated 10 times
...
template class itk::RandomImageSource<itk::Image<float, 2u> >; //Instantiated 39 times
...
template class itk::RandomImageSource<itk::Image<float, 3u> >; //Instantiated 21 times
