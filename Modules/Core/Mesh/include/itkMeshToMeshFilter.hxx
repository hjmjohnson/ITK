...
MeshToMeshFilter<TInputMesh, TOutputMesh>::CopyInputMeshToOutputMeshPoints()
{
  ...
  if (inputPoints)
  {
    ...
    typename InputPointsContainer::ConstIterator const inputEnd = inputPoints->End();
...
MeshToMeshFilter<TInputMesh, TOutputMesh>::CopyInputMeshToOutputMeshPointData()
{
  ...
  if (inputPointData)
  {
    ...
    typename InputPointDataContainer::ConstIterator const inputEnd = inputPointData->End();
...
MeshToMeshFilter<TInputMesh, TOutputMesh>::CopyInputMeshToOutputMeshCellLinks()
{
  ...
  if (inputCellLinks)
  {
    ...
    typename InputCellLinksContainer::ConstIterator const inputEnd = inputCellLinks->End();
...
MeshToMeshFilter<TInputMesh, TOutputMesh>::CopyInputMeshToOutputMeshCells()
{
  ...
  if (inputCells)
  {
    ...
    typename InputCellsContainer::ConstIterator const inputEnd = inputCells->End();
...
MeshToMeshFilter<TInputMesh, TOutputMesh>::CopyInputMeshToOutputMeshCellData()
{
  ...
  if (inputCellData)
  {
    ...
    typename InputCellDataContainer::ConstIterator const inputEnd = inputCellData->End();
