...
itkMeshSpatialObjectIOTest(int argc, char * argv[])
{
  ...
  MeshType::CoordRepType const testPointCoords[8][3] = { { 0, 1, 2 }, { 1, 2, 3 }, { 2, 3, 4 }, { 3, 4, 5 },
  ...
  reader->Update();
  ReaderType::GroupPointer const myScene = reader->GetGroup();
  if (!myScene)
  {
  ...
  MeshSpatialObjectType::Pointer const meshSO2 =
  ...
  MeshType::Pointer const mesh2 = meshSO2->GetMesh();
  // Testing points
