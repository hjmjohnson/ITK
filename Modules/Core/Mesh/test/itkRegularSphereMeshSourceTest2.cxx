...
itkRegularSphereMeshSourceTest2(int, char *[])
{
  ...
  MeshType::Pointer const mesh1 = source1->GetOutput();
  ...
  MeshType::Pointer const mesh2 = source2->GetOutput();

  mesh2->Graft(mesh1);

  MeshType::PointsContainerConstPointer const  points = mesh2->GetPoints();
  MeshType::PointsContainerConstIterator       it = points->Begin();
  MeshType::PointsContainerConstIterator const end = points->End();

  MeshType::PointType                    center = source2->GetCenter();
  SphereMeshSourceType::VectorType const scale2 = source2->GetScale();
