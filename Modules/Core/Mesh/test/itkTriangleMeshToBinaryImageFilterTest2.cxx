...
itkTriangleMeshToBinaryImageFilterTest2(int argc, char * argv[])
{
  ...
  VectorType const     scale = scaleInit;
  ...
  SimplexMeshType::Pointer const simplexMesh = simplexFilter->GetOutput();
  TriangleMeshPointer const      originalTriangleMesh = mySphereMeshSource->GetOutput();
  ...
  TriangleMeshType::Pointer const triangleMesh = backFilter->GetOutput();
