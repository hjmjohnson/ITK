...
itkTransformMeshFilterTest(int, char *[])
{
  ...
  int const                              n = 1;     // let's start with a few of them
  ...
  TransformType::OffsetType const      translation = tInit;
  ...
  MeshType::Pointer const outputMeshFromWithBase = filterwithbasetrfs->GetOutput();
  ...
  MeshType::PointsContainerPointer const transformedPoints = outputMesh->GetPoints();

  MeshType::PointsContainerPointer const transformedPointsFromWithBase = outputMeshFromWithBase->GetPoints();
