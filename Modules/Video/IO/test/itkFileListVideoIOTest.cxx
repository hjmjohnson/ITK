                     ...
                     double        inFpS)
{
  ...
  // Create the VideoIO
  itk::FileListVideoIO::Pointer const fileListIO = itk::FileListVideoIO::New();
  ...
  std::string const nonExistantFile = "Bad/Path/To/Nothing";
  ...
  for (SizeValueType i = 0; i < fileListIO->GetFrameTotal(); ++i)
  {
    ...
    size_t const bufferSize = fileListIO->GetImageSizeInBytes();
  ...
  SizeValueType const seekFrame = fileListIO->GetFrameTotal() - 1;
  ...
  itk::FileListVideoIO::Pointer const fileListIO2 = itk::FileListVideoIO::New();
  itk::FileListVideoIO::Pointer const fileListIO3 = itk::FileListVideoIO::New();
  ...
  for (unsigned int i = 0; i < inNumFrames; ++i)
  {
    ...
    size_t const bufferSize = fileListIO2->GetImageSizeInBytes();
    auto *       buffer = new PixelType[bufferSize];
