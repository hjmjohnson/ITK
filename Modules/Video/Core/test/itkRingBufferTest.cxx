...
itkRingBufferTest(int, char *[])
{
  ...
  unsigned int const oldHeadIndex = ringBuffer->GetHeadIndex();
  ...
  itk::Object::Pointer const obj1 = itk::Object::New();
  ...
  itk::Object::Pointer const objOut = ringBuffer->GetBufferContents(0);
  ...
  itk::Object::Pointer const obj2 = itk::Object::New();
