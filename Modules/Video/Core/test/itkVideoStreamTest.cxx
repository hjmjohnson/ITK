...
itkVideoStreamTest(int, char *[])
{
  ...
  FrameType::Pointer const outFrame1 = video2->GetFrame(0);
  FrameType::Pointer const outFrame2 = video2->GetFrame(1);
  FrameType::Pointer const outFrame3 = video2->GetFrame(2);
  ...
  SizeValueType const           startFrame = 0;
  SizeValueType const           numFrames = 5;
  ...
  FrameType::RegionType const largestSpatialRegion = SetUpSpatialRegion(100, 100);
  FrameType::RegionType const requestedSpatialRegion = SetUpSpatialRegion(40, 40);
  FrameType::RegionType const bufferedSpatialRegion = SetUpSpatialRegion(50, 40);
