...
#define CHECK_FOR_VALUE(a, b)                                                            \
  ...
  itk::SizeValueType const testFrameStart = 0;
  itk::SizeValueType const testFrameDuration = 20;
  ...
  itk::RealTimeInterval const tenSeconds(10, 0);
  ...
  bool const shouldBeTrue = regionA == regionB;
  CHECK_FOR_VALUE(shouldBeTrue, true);

  bool const shouldBeFalse = regionA != regionB;
