...
macro(itk_module_link_dependencies)
  ...
  endforeach()
  show_module_dependency_tree(${itk-module} 0 "")
endmacro()
...
macro(show_module_dependency_tree module from type)
  ...
  foreach(public_dep IN LISTS ITK_MODULE_${module}_PUBLIC_DEPENDS)
  ...
  endforeach()
  foreach(compile_dep IN LISTS ITK_MODULE_${module}_COMPILE_DEPENDS)
  ...
  endforeach()
  foreach(private_dep IN LISTS ITK_MODULE_${module}_PRIVATE_DEPENDS)
