...
main(int argc, char * argv[])
{
  ...
  unsigned int const numberOfGridNodesInOneDimensionCoarse = 5;
  ...
  unsigned int const numberOfGridNodesInOneDimensionFine = 20;
  ...
  for (unsigned int k = 0; k < SpaceDimension; ++k)
  {
    ...
    ParametersImageType::Pointer const newCoefficients =
