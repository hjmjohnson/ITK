...
main(int argc, char * argv[])
{
  ...
  RGB2DImageType::RegionType const largest =
  ...
  itk::SimpleFilterWatcher const watcher1(writer, "stream pasting writing");

  itk::SimpleFilterWatcher const watcher(grad, "stream gradient magnitude");
