...
main(int, char *[])
{
  ...
  PixelType const value0 = 34;
  PixelType const value1 = 67;
  ...
  // Software Guide : BeginCodeSnippet
  PointDataContainer::Pointer const pointData2 = pointSet->GetPointData();
  // Software Guide : EndCodeSnippet
  ...
  // Software Guide : BeginCodeSnippet
  PointDataIterator const end = pointData2->End();
  while (pointDataIterator != end)
  {
    PixelType const p = pointDataIterator.Value(); // access the pixel data
