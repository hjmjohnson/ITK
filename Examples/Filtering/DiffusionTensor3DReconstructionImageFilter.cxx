...
main(int argc, char * argv[])
{
  ...
  // ...
  //
  itk::MetaDataDictionary const imgMetaDictionary =
  ...
  TensorReconstructionImageFilterType::GradientDirectionContainerType::
    Pointer const DiffusionVectors = TensorReconstructionImageFilterType::
